...
impl EntityReference for crate::Quote {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/quote
#[derive(Debug)]
pub struct QuoteRequest<R = crate::Quote> {
    query: SelectQuery,
...
impl<R> Clone for QuoteRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> QuoteRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("Quote")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> QuoteRequest<T> {
        QuoteRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for Quote is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    fn dynamic_json_self_field(field: &str) -> Option<&'static str> {
        match field {
            ...
            "opportunity" | "opportunity_id" => Some("opportunity_id"),
            _ => None,
        }
    }
    ...
    fn apply_dynamic_json_chain_filter(self, head: &str, tail: &str, value: &JsonValue) -> Self {
        ...
        match head {
            "opportunity" => {
                self.with_opportunity_matching(
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("valid_until");
        self.query = self.query.project("create_time");
        self.query = self.query.project("update_time");
        self.query = self.query.project("version");
        self.query = self.query.project("opportunity_id");
        self
    }
    ...
    pub fn select_all(self) -> Self {
        ...
        request = request.select_opportunity();
        request
    }
    ...
    pub fn select_valid_until(mut self) -> Self {
        self.query = self.query.project("valid_until");
        self
    }

    pub fn project_valid_until(self) -> Self {
        self.select_valid_until()
    }

    pub fn select_valid_until_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_valid_until_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_valid_until_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("valid_until", raw_sql_segment));
        self
    }

    pub fn group_by_valid_until(self) -> Self {
        self.group_by("valid_until")
    }

    pub fn group_by_valid_until_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("valid_until");
        request.query = request
            .query
            .project_expr(alias, Expr::column("valid_until"));
        request
    }

    pub fn group_by_valid_until_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("valid_until")
            .aggregate_with_function("valid_until", alias, function)
    }

    pub fn count_valid_until(self) -> Self {
        self.count_valid_until_as("valid_until_count")
    }

    pub fn count_valid_until_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("valid_until", alias)
    }

    pub fn sum_valid_until(self) -> Self {
        self.sum_valid_until_as("sum_valid_until")
    }

    pub fn sum_valid_until_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("valid_until", alias)
    }

    pub fn avg_valid_until(self) -> Self {
        self.avg_valid_until_as("avg_valid_until")
    }

    pub fn avg_valid_until_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("valid_until", alias)
    }

    pub fn min_valid_until(self) -> Self {
        self.min_valid_until_as("min_valid_until")
    }

    pub fn min_valid_until_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("valid_until", alias)
    }

    pub fn max_valid_until(self) -> Self {
        self.max_valid_until_as("max_valid_until")
    }

    pub fn max_valid_until_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("valid_until", alias)
    }

    pub fn unselect_valid_until(mut self) -> Self {
        self.query.projection.retain(|field| field != "valid_until");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "valid_until");
        self
    }


    pub fn with_valid_until(
        mut self,
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
    ...
    pub fn create_valid_until_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_valid_until_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("valid_until", value));
        self
    }



    pub fn with_valid_until_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("valid_until", value));
        self
    }

    pub fn with_valid_until_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("valid_until", value));
        self
    }

    pub fn with_valid_until_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("valid_until", value));
        self
    }

    pub fn with_valid_until_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("valid_until", value));
        self
    }

    pub fn with_valid_until_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("valid_until", value));
        self
    }

    pub fn with_valid_until_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("valid_until", lower, upper));
        self
    }

    pub fn with_valid_until_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_valid_until_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_valid_until_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("valid_until", value));
        self
    }

    pub fn with_valid_until_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("valid_until", value));
        self
    }

    pub fn with_valid_until_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("valid_until"));
        self
    }



    pub fn with_valid_until_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("valid_until"));
        self
    }


    pub fn order_by_valid_until_asc(mut self) -> Self {
        self.query = self.query.order_asc("valid_until");
        self
    }

    pub fn order_by_valid_until_desc(mut self) -> Self {
        self.query = self.query.order_desc("valid_until");
        self
    }

    pub fn order_by_valid_until_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("valid_until");
        self
    }

    pub fn order_by_valid_until_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("valid_until");
        self
    }
    ...
    pub fn filter_by_opportunity(mut self, value: impl EntityReference) -> Self {
        self.query = self.query.and_filter(Expr::eq("opportunity_id", value.entity_id_value()));
        self
    }

    pub fn with_opportunity_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        ...
        self.relation_filters.push(RelationFilter::new("opportunity", selection));
        self
    }


    pub fn without_opportunity_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
    ...
    pub fn have_opportunity(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("opportunity_id"));
        self
    }

    pub fn have_no_opportunity(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("opportunity_id"));
        self
    }


    pub fn group_by_opportunity(self) -> Self {
        self.group_by("opportunity_id")
    }

    pub fn group_by_opportunity_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("opportunity_id");
        request.query = request
            .query
            .project_expr(alias, Expr::column("opportunity_id"));
        request
    }

    pub fn group_by_opportunity_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("opportunity_id")
            .aggregate_with_function("opportunity_id", alias, function)
    }

    pub fn group_by_opportunity_with(mut self, request: impl Into<QuerySelection>) -> Self {
        self.query = self.query.group_by("opportunity_id");
    ...
    pub fn group_by_opportunity_with_details(self) -> Self {
        self.group_by_opportunity_with_details_from(crate::Q::opportunities().unlimited())
    }

    pub fn group_by_opportunity_with_details_from(self, request: impl Into<QuerySelection>) -> Self {
        self.group_by_opportunity_with(request)
    }


    pub fn roll_up_to_opportunity(self) -> Self {
        self.roll_up_to_opportunity_with(crate::Q::opportunities().unlimited())
    }

    pub fn roll_up_to_opportunity_with(self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.with_opportunity_matching(selection.clone())
            .group_by_opportunity_with(selection)
    }

    pub fn count_opportunity(self) -> Self {
        self.count_opportunity_as("opportunity_count")
    }

    pub fn count_opportunity_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("opportunity_id", alias)
    }

    pub fn unselect_opportunity(mut self) -> Self {
        self.query.projection.retain(|field| field != "opportunity_id");
        self.query.relations.retain(|relation| relation.name != "opportunity");
        self
    }
    pub fn select_opportunity(mut self) -> Self {
        self.query = self.query.relation("opportunity");
        self
    }

    pub fn select_opportunity_with(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.relation_query("opportunity", selection.clone().into_query());
        self.relation_selections.push(RelationSelection::new("opportunity", selection));
        self
}

    pub fn facet_by_opportunity_as(self, facet_name: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.facet_by_opportunity_as_with_options(facet_name, request, true)
    }

    pub fn facet_by_opportunity_as_with_options(
        mut self,
...
impl<R> Default for QuoteRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< QuoteRequest<R> > for SelectQuery {
    fn from(request: QuoteRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< QuoteRequest<R> > for QuerySelection {
    fn from(request: QuoteRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::Quote> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::QuoteRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<QuoteRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::Quote
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::Quote::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> QuoteRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::QuoteRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
