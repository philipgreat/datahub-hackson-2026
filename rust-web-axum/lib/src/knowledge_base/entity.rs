...
#[teaql(entity = "KnowledgeBase", table = "knowledge_base_data", data_service = "sqlite")]
pub struct KnowledgeBase {
#[teaql(id)]
    id: u64,

// @source massive_erp_model.xml:500
    category: String,
...
impl KnowledgeBase {
    ...
    pub(crate) fn runtime_new(root: teaql_runtime::EntityRoot) -> Self {
        Self {
            ...
            content: String::new(),
            title: String::new(),
            views: rust_decimal::Decimal::ZERO,
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("KnowledgeBase", self.id)
    }
    ...
    pub fn views(&self) -> rust_decimal::Decimal {
        self.changed_views().and_then(|value| value.try_decimal()).unwrap_or(self.views)
    }

    pub fn update_views(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.views = value.try_decimal().unwrap_or(self.views.clone());
        self.root.set(self.entity_key(), "views", value);
        self
    }

    pub fn changed_views(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "views")
    }

    pub fn eval_views(&self) -> teaql_core::eval::EvalResult<rust_decimal::Decimal> {
        if !self.is_loaded("views") {
                    teaql_core::eval::EvalResult::NotLoaded { failed_node: "views".to_string(), attempted_path: "views".to_string() }
                } else {
                    teaql_core::eval::EvalResult::Value(self.views())
                }}
