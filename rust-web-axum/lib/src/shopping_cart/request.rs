...
impl EntityReference for crate::ShoppingCart {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/shopping_cart
#[derive(Debug)]
pub struct ShoppingCartRequest<R = crate::ShoppingCart> {
    query: SelectQuery,
...
impl<R> Clone for ShoppingCartRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> ShoppingCartRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("ShoppingCart")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> ShoppingCartRequest<T> {
        ShoppingCartRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for ShoppingCart is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    fn dynamic_json_self_field(field: &str) -> Option<&'static str> {
        match field {
            ...
            "is_abandoned" => Some("is_abandoned"),
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("is_abandoned");
        self.query = self.query.project("session_id");
    ...
    pub fn select_is_abandoned(mut self) -> Self {
        self.query = self.query.project("is_abandoned");
        self
    }

    pub fn project_is_abandoned(self) -> Self {
        self.select_is_abandoned()
    }

    pub fn select_is_abandoned_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_is_abandoned_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_is_abandoned_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("is_abandoned", raw_sql_segment));
        self
    }

    pub fn group_by_is_abandoned(self) -> Self {
        self.group_by("is_abandoned")
    }

    pub fn group_by_is_abandoned_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("is_abandoned");
        request.query = request
            .query
            .project_expr(alias, Expr::column("is_abandoned"));
        request
    }

    pub fn group_by_is_abandoned_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("is_abandoned")
            .aggregate_with_function("is_abandoned", alias, function)
    }

    pub fn count_is_abandoned(self) -> Self {
        self.count_is_abandoned_as("is_abandoned_count")
    }

    pub fn count_is_abandoned_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("is_abandoned", alias)
    }

    pub fn sum_is_abandoned(self) -> Self {
        self.sum_is_abandoned_as("sum_is_abandoned")
    }

    pub fn sum_is_abandoned_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("is_abandoned", alias)
    }

    pub fn avg_is_abandoned(self) -> Self {
        self.avg_is_abandoned_as("avg_is_abandoned")
    }

    pub fn avg_is_abandoned_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("is_abandoned", alias)
    }

    pub fn min_is_abandoned(self) -> Self {
        self.min_is_abandoned_as("min_is_abandoned")
    }

    pub fn min_is_abandoned_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("is_abandoned", alias)
    }

    pub fn max_is_abandoned(self) -> Self {
        self.max_is_abandoned_as("max_is_abandoned")
    }

    pub fn max_is_abandoned_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("is_abandoned", alias)
    }

    pub fn unselect_is_abandoned(mut self) -> Self {
        self.query.projection.retain(|field| field != "is_abandoned");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "is_abandoned");
        self
    }


    pub fn with_is_abandoned(
        mut self,
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
    ...
    pub fn create_is_abandoned_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_is_abandoned_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("is_abandoned", value));
        self
    }



    pub fn with_is_abandoned_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("is_abandoned", value));
        self
    }

    pub fn with_is_abandoned_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("is_abandoned", value));
        self
    }

    pub fn with_is_abandoned_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("is_abandoned", value));
        self
    }

    pub fn with_is_abandoned_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("is_abandoned", value));
        self
    }

    pub fn with_is_abandoned_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("is_abandoned", value));
        self
    }

    pub fn with_is_abandoned_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("is_abandoned", lower, upper));
        self
    }

    pub fn with_is_abandoned_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_is_abandoned_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_is_abandoned_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("is_abandoned", value));
        self
    }

    pub fn with_is_abandoned_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("is_abandoned", value));
        self
    }

    pub fn with_is_abandoned_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("is_abandoned"));
        self
    }



    pub fn with_is_abandoned_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("is_abandoned"));
        self
    }


    pub fn order_by_is_abandoned_asc(mut self) -> Self {
        self.query = self.query.order_asc("is_abandoned");
        self
    }

    pub fn order_by_is_abandoned_desc(mut self) -> Self {
        self.query = self.query.order_desc("is_abandoned");
        self
    }

    pub fn order_by_is_abandoned_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("is_abandoned");
        self
    }

    pub fn order_by_is_abandoned_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("is_abandoned");
        self
    }


    pub fn select_session_id(mut self) -> Self {
        self.query = self.query.project("session_id");
        self
    }

    pub fn project_session_id(self) -> Self {
        self.select_session_id()
    }

    pub fn select_session_id_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_session_id_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_session_id_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("session_id", raw_sql_segment));
        self
    }

    pub fn group_by_session_id(self) -> Self {
        self.group_by("session_id")
    }

    pub fn group_by_session_id_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("session_id");
        request.query = request
            .query
            .project_expr(alias, Expr::column("session_id"));
        request
    }

    pub fn group_by_session_id_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("session_id")
            .aggregate_with_function("session_id", alias, function)
    }

    pub fn count_session_id(self) -> Self {
        self.count_session_id_as("session_id_count")
    }

    pub fn count_session_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("session_id", alias)
    }

    pub fn sum_session_id(self) -> Self {
        self.sum_session_id_as("sum_session_id")
    }

    pub fn sum_session_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("session_id", alias)
    }

    pub fn avg_session_id(self) -> Self {
        self.avg_session_id_as("avg_session_id")
    }

    pub fn avg_session_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("session_id", alias)
    }

    pub fn min_session_id(self) -> Self {
        self.min_session_id_as("min_session_id")
    }

    pub fn min_session_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("session_id", alias)
    }

    pub fn max_session_id(self) -> Self {
        self.max_session_id_as("max_session_id")
    }

    pub fn max_session_id_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("session_id", alias)
    }

    pub fn unselect_session_id(mut self) -> Self {
        self.query.projection.retain(|field| field != "session_id");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "session_id");
        self
    }
    ...
    pub fn create_session_id_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_session_id_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("session_id", value));
        self
    }



    pub fn with_session_id_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("session_id", value));
        self
    }

    pub fn with_session_id_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("session_id", value));
        self
    }

    pub fn with_session_id_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("session_id", value));
        self
    }

    pub fn with_session_id_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("session_id", value));
        self
    }

    pub fn with_session_id_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("session_id", value));
        self
    }

    pub fn with_session_id_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("session_id", lower, upper));
        self
    }

    pub fn with_session_id_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_session_id_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("session_id", value));
        self
    }

    pub fn with_session_id_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("session_id", value));
        self
    }

    pub fn with_session_id_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("session_id", value));
        self
    }

    pub fn with_session_id_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("session_id", value));
        self
    }

    pub fn with_session_id_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("session_id", value));
        self
    }

    pub fn with_session_id_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("session_id", value));
        self
    }

    pub fn with_session_id_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("session_id", value));
        self
    }
    pub fn with_session_id_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("session_id", value));
        self
    }

    pub fn with_session_id_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("session_id", value));
        self
    }

    pub fn with_session_id_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("session_id"));
        self
    }



    pub fn with_session_id_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("session_id"));
        self
    }


    pub fn order_by_session_id_asc(mut self) -> Self {
        self.query = self.query.order_asc("session_id");
        self
    }

    pub fn order_by_session_id_desc(mut self) -> Self {
        self.query = self.query.order_desc("session_id");
        self
    }

    pub fn order_by_session_id_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("session_id");
        self
    }

    pub fn order_by_session_id_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("session_id");
        self
    }
...
impl<R> Default for ShoppingCartRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< ShoppingCartRequest<R> > for SelectQuery {
    fn from(request: ShoppingCartRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< ShoppingCartRequest<R> > for QuerySelection {
    fn from(request: ShoppingCartRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::ShoppingCart> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::ShoppingCartRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<ShoppingCartRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::ShoppingCart
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::ShoppingCart::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> ShoppingCartRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::ShoppingCartRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
