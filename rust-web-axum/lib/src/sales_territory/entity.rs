...
#[teaql(entity = "SalesTerritory", table = "sales_territory_data", data_service = "sqlite")]
pub struct SalesTerritory {
#[teaql(id)]
    id: u64,

// @source massive_erp_model.xml:179
    name: String,
...
impl SalesTerritory {
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("SalesTerritory", self.id)
    }
