...
impl<'a> PayrollExpression<'a> {
    ...
    pub fn get_tax(self) -> crate::ValueExpression<'a, rust_decimal::Decimal> {
        let next = self.result.and_then("tax", |entity| entity.eval_tax());
        crate::ValueExpression::new(next, self.root_desc.clone())
    }
    ...
    pub fn get_period_end(self) -> crate::ValueExpression<'a, teaql_core::time::Timestamp> {
        let next = self.result.and_then("period_end", |entity| entity.eval_period_end());
        crate::ValueExpression::new(next, self.root_desc.clone())
    }

    pub fn get_period_start(self) -> crate::ValueExpression<'a, teaql_core::time::Timestamp> {
