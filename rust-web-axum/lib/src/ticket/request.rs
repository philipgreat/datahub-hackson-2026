...
impl EntityReference for crate::Ticket {
...
#[derive(Debug)]
pub struct TicketRequest<R = crate::Ticket> {
    query: SelectQuery,
...
impl<R> Clone for TicketRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> TicketRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("Ticket")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> TicketRequest<T> {
        TicketRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for Ticket is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    fn apply_dynamic_json_chain_filter(self, head: &str, tail: &str, value: &JsonValue) -> Self {
        ...
        match head {
            ...
            "ticket_comment_list" => {
                self.with_ticket_comment_list_matching(
                    crate::Q::ticket_comments_minimal()
                        .apply_dynamic_json_filter(tail, value),
                )
            }
            _ => self,
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("priority");
    ...
    pub fn select_children(self) -> Self {
        ...
        request = request.select_ticket_comment_list();
        request
    }
    ...
    pub fn select_priority(mut self) -> Self {
        self.query = self.query.project("priority");
        self
    }

    pub fn project_priority(self) -> Self {
        self.select_priority()
    }

    pub fn select_priority_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_priority_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_priority_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("priority", raw_sql_segment));
        self
    }

    pub fn group_by_priority(self) -> Self {
        self.group_by("priority")
    }

    pub fn group_by_priority_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("priority");
        request.query = request
            .query
            .project_expr(alias, Expr::column("priority"));
        request
    }

    pub fn group_by_priority_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("priority")
            .aggregate_with_function("priority", alias, function)
    }

    pub fn count_priority(self) -> Self {
        self.count_priority_as("priority_count")
    }

    pub fn count_priority_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("priority", alias)
    }

    pub fn sum_priority(self) -> Self {
        self.sum_priority_as("sum_priority")
    }

    pub fn sum_priority_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("priority", alias)
    }

    pub fn avg_priority(self) -> Self {
        self.avg_priority_as("avg_priority")
    }

    pub fn avg_priority_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("priority", alias)
    }

    pub fn min_priority(self) -> Self {
        self.min_priority_as("min_priority")
    }

    pub fn min_priority_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("priority", alias)
    }

    pub fn max_priority(self) -> Self {
        self.max_priority_as("max_priority")
    }

    pub fn max_priority_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("priority", alias)
    }

    pub fn unselect_priority(mut self) -> Self {
        self.query.projection.retain(|field| field != "priority");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "priority");
        self
    }
    ...
    pub fn create_priority_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_priority_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("priority", value));
        self
    }



    pub fn with_priority_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("priority", value));
        self
    }

    pub fn with_priority_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("priority", value));
        self
    }

    pub fn with_priority_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("priority", value));
        self
    }

    pub fn with_priority_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("priority", value));
        self
    }

    pub fn with_priority_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("priority", value));
        self
    }

    pub fn with_priority_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("priority", lower, upper));
        self
    }

    pub fn with_priority_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_priority_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("priority", value));
        self
    }

    pub fn with_priority_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("priority", value));
        self
    }

    pub fn with_priority_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("priority", value));
        self
    }

    pub fn with_priority_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("priority", value));
        self
    }

    pub fn with_priority_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("priority", value));
        self
    }

    pub fn with_priority_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("priority", value));
        self
    }

    pub fn with_priority_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("priority", value));
        self
    }
    pub fn with_priority_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("priority", value));
        self
    }

    pub fn with_priority_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("priority", value));
        self
    }

    pub fn with_priority_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("priority"));
        self
    }



    pub fn with_priority_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("priority"));
        self
    }


    pub fn order_by_priority_asc(mut self) -> Self {
        self.query = self.query.order_asc("priority");
        self
    }

    pub fn order_by_priority_desc(mut self) -> Self {
        self.query = self.query.order_desc("priority");
        self
    }

    pub fn order_by_priority_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("priority");
        self
    }

    pub fn order_by_priority_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("priority");
        self
    }
    ...
    pub fn have_ticket_comments(self) -> Self {
        self.with_ticket_comment_list_matching(SelectQuery::new("TicketComment"))
    }

    pub fn have_no_ticket_comments(self) -> Self {
        self.without_ticket_comment_list_matching(SelectQuery::new("TicketComment"))
    }

    pub fn with_ticket_comment_list_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.and_filter(Expr::in_subquery(
            "id",
            <crate::TicketComment as teaql_core::TeaqlEntity>::entity_descriptor(),
            selection.query.clone(),
            "ticket_id",
        ));
        self.relation_filters.push(RelationFilter::new("ticket_comment_list", selection));
        self
    }

    pub fn without_ticket_comment_list_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.and_filter(Expr::not_in_subquery(
            "id",
            <crate::TicketComment as teaql_core::TeaqlEntity>::entity_descriptor(),
    ...
    pub fn select_ticket_comment_list(mut self) -> Self {
        self.query = self.query.relation("ticket_comment_list");
        self
    }

    pub fn select_ticket_comment_list_with(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.relation_query("ticket_comment_list", selection.clone().into_query());
        self.relation_selections.push(RelationSelection::new("ticket_comment_list", selection));
        self
}
    pub fn count_ticket_comments(self) -> Self {
        self.count_ticket_comments_as("count_ticket_comments")
    }

    pub fn count_ticket_comments_as(self, alias: impl Into<String>) -> Self {
        self.count_ticket_comments_with(alias, crate::Q::ticket_comments().unlimited())
    }

    pub fn count_ticket_comments_with(mut self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
    ...
    pub fn stats_from_ticket_comments(self, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_ticket_comments_as("refinements", request)
    }

    pub fn stats_from_ticket_comments_as(mut self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query_options.relation_aggregates.push(RelationAggregate::new(
            "ticket_comment_list",
            alias,
    ...
    pub fn group_by_ticket_comments_with_details(self, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_ticket_comments(request)
    }


    pub fn min_created_at_of_ticket_comments(self) -> Self {
        self.min_created_at_of_ticket_comments_as("min_created_at_of_ticket_comments", crate::Q::ticket_comments().unlimited())
    }

    pub fn min_created_at_of_ticket_comments_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_ticket_comments_as(alias, request.into().into_query().min("created_at", "min_created_at"))
    }
    pub fn max_created_at_of_ticket_comments(self) -> Self {
        self.max_created_at_of_ticket_comments_as("max_created_at_of_ticket_comments", crate::Q::ticket_comments().unlimited())
    }

    pub fn max_created_at_of_ticket_comments_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_ticket_comments_as(alias, request.into().into_query().max("created_at", "max_created_at"))
    }
    pub fn min_create_time_of_ticket_comments(self) -> Self {
        self.min_create_time_of_ticket_comments_as("min_create_time_of_ticket_comments", crate::Q::ticket_comments().unlimited())
    }

    pub fn min_create_time_of_ticket_comments_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_ticket_comments_as(alias, request.into().into_query().min("create_time", "min_create_time"))
    }
    pub fn max_create_time_of_ticket_comments(self) -> Self {
        self.max_create_time_of_ticket_comments_as("max_create_time_of_ticket_comments", crate::Q::ticket_comments().unlimited())
    }

    pub fn max_create_time_of_ticket_comments_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_ticket_comments_as(alias, request.into().into_query().max("create_time", "max_create_time"))
    }
    pub fn min_update_time_of_ticket_comments(self) -> Self {
        self.min_update_time_of_ticket_comments_as("min_update_time_of_ticket_comments", crate::Q::ticket_comments().unlimited())
    }

    pub fn min_update_time_of_ticket_comments_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_ticket_comments_as(alias, request.into().into_query().min("update_time", "min_update_time"))
    }
    pub fn max_update_time_of_ticket_comments(self) -> Self {
        self.max_update_time_of_ticket_comments_as("max_update_time_of_ticket_comments", crate::Q::ticket_comments().unlimited())
    }

    pub fn max_update_time_of_ticket_comments_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_ticket_comments_as(alias, request.into().into_query().max("update_time", "max_update_time"))
    }
}

impl<R> Default for TicketRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< TicketRequest<R> > for SelectQuery {
    fn from(request: TicketRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< TicketRequest<R> > for QuerySelection {
    fn from(request: TicketRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::Ticket> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::TicketRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<TicketRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::Ticket
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::Ticket::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> TicketRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::TicketRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
