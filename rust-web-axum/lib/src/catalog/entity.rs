...
#[teaql(entity = "Catalog", table = "catalog_data", data_service = "sqlite")]
pub struct Catalog {
#[teaql(id)]
    id: u64,

// @source massive_erp_model.xml:211
    name: String,
...
// @source massive_erp_model.xml:211
    valid_from: teaql_core::time::Timestamp,

// @source massive_erp_model.xml:211
    valid_to: teaql_core::time::Timestamp,
...
impl Catalog {
    ...
    pub(crate) fn runtime_new(root: teaql_runtime::EntityRoot) -> Self {
        Self {
            ...
            name: String::new(),
            season: String::new(),
            valid_from: teaql_core::time::Timestamp::now(),
            valid_to: teaql_core::time::Timestamp::now(),
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("Catalog", self.id)
    }
    ...
    pub fn season(&self) -> String {
        self.changed_season().and_then(|value| value.try_text().map(|value| value.to_owned())).unwrap_or_else(|| self.season.clone())
    }

    pub fn update_season(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.season = value.try_text().map(|value| value.trim().to_owned()).unwrap_or_else(|| self.season.clone());
        self.root.set(self.entity_key(), "season", value);
        self
    }

    pub fn changed_season(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "season")
    }

    pub fn eval_season(&self) -> teaql_core::eval::EvalResult<String> {
        if !self.is_loaded("season") {
                    teaql_core::eval::EvalResult::NotLoaded { failed_node: "season".to_string(), attempted_path: "season".to_string() }
                } else {
                    teaql_core::eval::EvalResult::Value(self.season())
                }}

    pub fn valid_from(&self) -> teaql_core::time::Timestamp {
    ...
    pub fn eval_valid_from(&self) -> teaql_core::eval::EvalResult<teaql_core::time::Timestamp> {
    ...
    pub fn valid_to(&self) -> teaql_core::time::Timestamp {
    ...
    pub fn eval_valid_to(&self) -> teaql_core::eval::EvalResult<teaql_core::time::Timestamp> {
