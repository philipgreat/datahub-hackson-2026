...
impl EntityReference for crate::Catalog {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/catalog
#[derive(Debug)]
pub struct CatalogRequest<R = crate::Catalog> {
    query: SelectQuery,
...
impl<R> Clone for CatalogRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> CatalogRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("Catalog")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> CatalogRequest<T> {
        CatalogRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for Catalog is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("season");
    ...
    pub fn select_season(mut self) -> Self {
        self.query = self.query.project("season");
        self
    }

    pub fn project_season(self) -> Self {
        self.select_season()
    }

    pub fn select_season_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_season_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_season_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("season", raw_sql_segment));
        self
    }

    pub fn group_by_season(self) -> Self {
        self.group_by("season")
    }

    pub fn group_by_season_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("season");
        request.query = request
            .query
            .project_expr(alias, Expr::column("season"));
        request
    }

    pub fn group_by_season_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("season")
            .aggregate_with_function("season", alias, function)
    }

    pub fn count_season(self) -> Self {
        self.count_season_as("season_count")
    }

    pub fn count_season_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("season", alias)
    }

    pub fn sum_season(self) -> Self {
        self.sum_season_as("sum_season")
    }

    pub fn sum_season_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("season", alias)
    }

    pub fn avg_season(self) -> Self {
        self.avg_season_as("avg_season")
    }

    pub fn avg_season_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("season", alias)
    }

    pub fn min_season(self) -> Self {
        self.min_season_as("min_season")
    }

    pub fn min_season_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("season", alias)
    }

    pub fn max_season(self) -> Self {
        self.max_season_as("max_season")
    }

    pub fn max_season_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("season", alias)
    }

    pub fn unselect_season(mut self) -> Self {
        self.query.projection.retain(|field| field != "season");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "season");
        self
    }
    ...
    pub fn with_season_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("season", value));
        self
    }



    pub fn with_season_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("season", value));
        self
    }

    pub fn with_season_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("season", value));
        self
    }

    pub fn with_season_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("season", value));
        self
    }

    pub fn with_season_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("season", value));
        self
    }

    pub fn with_season_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("season", value));
        self
    }

    pub fn with_season_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("season", lower, upper));
        self
    }

    pub fn with_season_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_season_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("season", value));
        self
    }

    pub fn with_season_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("season", value));
        self
    }

    pub fn with_season_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("season", value));
        self
    }

    pub fn with_season_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("season", value));
        self
    }

    pub fn with_season_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("season", value));
        self
    }

    pub fn with_season_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("season", value));
        self
    }

    pub fn with_season_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("season", value));
        self
    }
    pub fn with_season_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("season", value));
        self
    }

    pub fn with_season_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("season", value));
        self
    }

    pub fn with_season_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("season"));
        self
    }



    pub fn with_season_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("season"));
        self
    }


    pub fn order_by_season_asc(mut self) -> Self {
        self.query = self.query.order_asc("season");
        self
    }

    pub fn order_by_season_desc(mut self) -> Self {
        self.query = self.query.order_desc("season");
        self
    }

    pub fn order_by_season_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("season");
        self
    }

    pub fn order_by_season_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("season");
        self
    }
    ...
    pub fn season_is_season_value(self) -> Self {
        self.with_season_is("season_value")
    }

    pub fn with_season_is_season_value(self) -> Self {
        self.with_season_is("season_value")
    }



    pub fn with_season_is_not_season_value(self) -> Self {
        self.with_season_is_not("season_value")
    }



    pub fn valid_from_is_create_time(self) -> Self {
        self.with_valid_from_is("createTime()")
    }

    pub fn with_valid_from_is_create_time(self) -> Self {
        self.with_valid_from_is("createTime()")
    }



    pub fn with_valid_from_is_not_create_time(self) -> Self {
        self.with_valid_from_is_not("createTime()")
    }



    pub fn valid_to_is_create_time(self) -> Self {
        self.with_valid_to_is("createTime()")
    }

    pub fn with_valid_to_is_create_time(self) -> Self {
        self.with_valid_to_is("createTime()")
    }



    pub fn with_valid_to_is_not_create_time(self) -> Self {
        self.with_valid_to_is_not("createTime()")
    }
...
impl<R> Default for CatalogRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< CatalogRequest<R> > for SelectQuery {
    fn from(request: CatalogRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< CatalogRequest<R> > for QuerySelection {
    fn from(request: CatalogRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::Catalog> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::CatalogRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<CatalogRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::Catalog
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::Catalog::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> CatalogRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::CatalogRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
