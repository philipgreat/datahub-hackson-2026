...
// @source massive_erp_model.xml:116
    email: String,
...
#[teaql(version)]
    version: i64,
#[teaql(relation(target = "Opportunity", local_key = "id", foreign_key = "lead_id", many))]
    opportunity_list: SmartList<crate::Opportunity>,
    #[teaql(dynamic)]
...
impl Lead {
    ...
    pub(crate) fn runtime_new(root: teaql_runtime::EntityRoot) -> Self {
        Self {
            ...
            name: String::new(),
            phone: String::new(),
            converted_customer_id: String::new(),
            source: String::new(),
            status: String::new(),
            create_time: teaql_core::time::Timestamp::now(),
            update_time: teaql_core::time::Timestamp::now(),
            version: 0_i64,
            opportunity_list: Default::default(),
    ...
    pub fn attach_root_recursive(&mut self, root: teaql_runtime::EntityRoot) {
        ...
        for entity in &mut self.opportunity_list {
    ...
    pub fn converted_customer_id(&self) -> String {
        self.changed_converted_customer_id().and_then(|value| value.try_text().map(|value| value.to_owned())).unwrap_or_else(|| self.converted_customer_id.clone())
    }

    pub fn update_converted_customer_id(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.converted_customer_id = value.try_text().map(|value| value.trim().to_owned()).unwrap_or_else(|| self.converted_customer_id.clone());
        self.root.set(self.entity_key(), "converted_customer_id", value);
        self
    }

    pub fn changed_converted_customer_id(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "converted_customer_id")
    }

    pub fn eval_converted_customer_id(&self) -> teaql_core::eval::EvalResult<String> {
        if !self.is_loaded("converted_customer_id") {
                    teaql_core::eval::EvalResult::NotLoaded { failed_node: "converted_customer_id".to_string(), attempted_path: "converted_customer_id".to_string() }
                } else {
                    teaql_core::eval::EvalResult::Value(self.converted_customer_id())
                }}
    ...
    pub fn opportunity_list(&self) -> &SmartList<crate::Opportunity> {
        &self.opportunity_list
    }

    pub fn opportunity_list_mut(&mut self) -> &mut SmartList<crate::Opportunity> {
        &mut self.opportunity_list
    }

    pub fn eval_opportunity_list(&self) -> teaql_core::eval::EvalResult<&SmartList<crate::Opportunity>> {
        if !self.is_loaded("opportunity_list") {
            teaql_core::eval::EvalResult::NotLoaded { failed_node: "opportunity_list".to_string(), attempted_path: "opportunity_list".to_string() }
        } else {
            teaql_core::eval::EvalResult::Value(&self.opportunity_list)
        }
    }
