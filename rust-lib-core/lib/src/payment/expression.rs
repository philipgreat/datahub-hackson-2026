...
impl<'a> PaymentExpression<'a> {
    ...
    pub fn get_card_last4(self) -> crate::ValueExpression<'a, String> {
        let next = self.result.and_then("card_last4", |entity| entity.eval_card_last4());
        crate::ValueExpression::new(next, self.root_desc.clone())
    }

    pub fn get_payment_date(self) -> crate::ValueExpression<'a, teaql_core::time::Timestamp> {
