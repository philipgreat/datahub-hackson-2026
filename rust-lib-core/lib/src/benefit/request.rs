...
impl EntityReference for crate::Benefit {
...
#[derive(Debug)]
pub struct BenefitRequest<R = crate::Benefit> {
    query: SelectQuery,
...
impl<R> Clone for BenefitRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> BenefitRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("Benefit")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> BenefitRequest<T> {
        BenefitRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for Benefit is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("plan_type");
    ...
    pub fn select_plan_type(mut self) -> Self {
        self.query = self.query.project("plan_type");
        self
    }

    pub fn project_plan_type(self) -> Self {
        self.select_plan_type()
    }

    pub fn select_plan_type_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_plan_type_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_plan_type_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("plan_type", raw_sql_segment));
        self
    }

    pub fn group_by_plan_type(self) -> Self {
        self.group_by("plan_type")
    }

    pub fn group_by_plan_type_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("plan_type");
        request.query = request
            .query
            .project_expr(alias, Expr::column("plan_type"));
        request
    }

    pub fn group_by_plan_type_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("plan_type")
            .aggregate_with_function("plan_type", alias, function)
    }

    pub fn count_plan_type(self) -> Self {
        self.count_plan_type_as("plan_type_count")
    }

    pub fn count_plan_type_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("plan_type", alias)
    }

    pub fn sum_plan_type(self) -> Self {
        self.sum_plan_type_as("sum_plan_type")
    }

    pub fn sum_plan_type_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("plan_type", alias)
    }

    pub fn avg_plan_type(self) -> Self {
        self.avg_plan_type_as("avg_plan_type")
    }

    pub fn avg_plan_type_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("plan_type", alias)
    }

    pub fn min_plan_type(self) -> Self {
        self.min_plan_type_as("min_plan_type")
    }

    pub fn min_plan_type_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("plan_type", alias)
    }

    pub fn max_plan_type(self) -> Self {
        self.max_plan_type_as("max_plan_type")
    }

    pub fn max_plan_type_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("plan_type", alias)
    }

    pub fn unselect_plan_type(mut self) -> Self {
        self.query.projection.retain(|field| field != "plan_type");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "plan_type");
        self
    }
    ...
    pub fn create_plan_type_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_plan_type_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("plan_type", value));
        self
    }



    pub fn with_plan_type_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("plan_type", value));
        self
    }

    pub fn with_plan_type_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("plan_type", value));
        self
    }

    pub fn with_plan_type_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("plan_type", value));
        self
    }

    pub fn with_plan_type_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("plan_type", value));
        self
    }

    pub fn with_plan_type_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("plan_type", value));
        self
    }

    pub fn with_plan_type_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("plan_type", lower, upper));
        self
    }

    pub fn with_plan_type_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_plan_type_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("plan_type", value));
        self
    }

    pub fn with_plan_type_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("plan_type", value));
        self
    }

    pub fn with_plan_type_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("plan_type", value));
        self
    }

    pub fn with_plan_type_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("plan_type", value));
        self
    }

    pub fn with_plan_type_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("plan_type", value));
        self
    }

    pub fn with_plan_type_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("plan_type", value));
        self
    }

    pub fn with_plan_type_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("plan_type", value));
        self
    }
    pub fn with_plan_type_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("plan_type", value));
        self
    }

    pub fn with_plan_type_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("plan_type", value));
        self
    }

    pub fn with_plan_type_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("plan_type"));
        self
    }



    pub fn with_plan_type_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("plan_type"));
        self
    }


    pub fn order_by_plan_type_asc(mut self) -> Self {
        self.query = self.query.order_asc("plan_type");
        self
    }

    pub fn order_by_plan_type_desc(mut self) -> Self {
        self.query = self.query.order_desc("plan_type");
        self
    }

    pub fn order_by_plan_type_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("plan_type");
        self
    }

    pub fn order_by_plan_type_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("plan_type");
        self
    }
...
impl<R> Default for BenefitRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< BenefitRequest<R> > for SelectQuery {
    fn from(request: BenefitRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< BenefitRequest<R> > for QuerySelection {
    fn from(request: BenefitRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::Benefit> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::BenefitRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<BenefitRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::Benefit
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::Benefit::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> BenefitRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::BenefitRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
