...
impl EntityReference for crate::Department {
...
#[derive(Debug)]
pub struct DepartmentRequest<R = crate::Department> {
    query: SelectQuery,
...
impl<R> Clone for DepartmentRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> DepartmentRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("Department")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> DepartmentRequest<T> {
        DepartmentRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for Department is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn budget_is_value_100_00(self) -> Self {
        self.with_budget_is("100.00")
    }

    pub fn with_budget_is_value_100_00(self) -> Self {
        self.with_budget_is("100.00")
    }



    pub fn with_budget_is_not_value_100_00(self) -> Self {
        self.with_budget_is_not("100.00")
    }
    ...
    pub fn sum_salary_of_employees(self) -> Self {
        self.sum_salary_of_employees_as("sum_salary_of_employees", crate::Q::employees().unlimited())
    }

    pub fn sum_salary_of_employees_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_employees_as(alias, request.into().into_query().sum("salary", "sum_salary"))
    }
    pub fn min_salary_of_employees(self) -> Self {
        self.min_salary_of_employees_as("min_salary_of_employees", crate::Q::employees().unlimited())
    }

    pub fn min_salary_of_employees_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_employees_as(alias, request.into().into_query().min("salary", "min_salary"))
    }
    pub fn max_salary_of_employees(self) -> Self {
        self.max_salary_of_employees_as("max_salary_of_employees", crate::Q::employees().unlimited())
    }

    pub fn max_salary_of_employees_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_employees_as(alias, request.into().into_query().max("salary", "max_salary"))
    }
    pub fn avg_salary_of_employees(self) -> Self {
        self.avg_salary_of_employees_as("avg_salary_of_employees", crate::Q::employees().unlimited())
    }

    pub fn avg_salary_of_employees_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_employees_as(alias, request.into().into_query().avg("salary", "avg_salary"))
    }
    pub fn standard_deviation_salary_of_employees(self) -> Self {
        self.standard_deviation_salary_of_employees_as("standard_deviation_salary_of_employees", crate::Q::employees().unlimited())
    }

    pub fn standard_deviation_salary_of_employees_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_employees_as(alias, request.into().into_query().stddev("salary", "stdDev_salary"))
    }
    pub fn square_root_of_population_standard_deviation_salary_of_employees(self) -> Self {
        self.square_root_of_population_standard_deviation_salary_of_employees_as("square_root_of_population_standard_deviation_salary_of_employees", crate::Q::employees().unlimited())
    }

    pub fn square_root_of_population_standard_deviation_salary_of_employees_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_employees_as(alias, request.into().into_query().stddev_pop("salary", "stdDevPop_salary"))
    }
    pub fn sample_variance_salary_of_employees(self) -> Self {
        self.sample_variance_salary_of_employees_as("sample_variance_salary_of_employees", crate::Q::employees().unlimited())
    }

    pub fn sample_variance_salary_of_employees_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_employees_as(alias, request.into().into_query().var_samp("salary", "varSamp_salary"))
    }
    pub fn sample_population_variance_salary_of_employees(self) -> Self {
        self.sample_population_variance_salary_of_employees_as("sample_population_variance_salary_of_employees", crate::Q::employees().unlimited())
    }

    pub fn sample_population_variance_salary_of_employees_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_employees_as(alias, request.into().into_query().var_pop("salary", "varPop_salary"))
    }
    pub fn min_hire_date_of_employees(self) -> Self {
        self.min_hire_date_of_employees_as("min_hire_date_of_employees", crate::Q::employees().unlimited())
    }

    pub fn min_hire_date_of_employees_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_employees_as(alias, request.into().into_query().min("hire_date", "min_hire_date"))
    }
    pub fn max_hire_date_of_employees(self) -> Self {
        self.max_hire_date_of_employees_as("max_hire_date_of_employees", crate::Q::employees().unlimited())
    }

    pub fn max_hire_date_of_employees_as(self, alias: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.stats_from_employees_as(alias, request.into().into_query().max("hire_date", "max_hire_date"))
    }
...
impl<R> Default for DepartmentRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< DepartmentRequest<R> > for SelectQuery {
    fn from(request: DepartmentRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< DepartmentRequest<R> > for QuerySelection {
    fn from(request: DepartmentRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::Department> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::DepartmentRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<DepartmentRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::Department
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::Department::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> DepartmentRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::DepartmentRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
