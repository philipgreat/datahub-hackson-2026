...
impl EntityReference for crate::OrderItem {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/order_item
#[derive(Debug)]
pub struct OrderItemRequest<R = crate::OrderItem> {
    query: SelectQuery,
...
impl<R> Clone for OrderItemRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> OrderItemRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("OrderItem")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> OrderItemRequest<T> {
        OrderItemRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for OrderItem is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn select_unit_price_with_function(self, function: AggregateFunction) -> Self {
        self.select_unit_price_as_with_function("unit_price", function)
    }

    pub fn select_unit_price_as_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.aggregate_with_function("unit_price", alias, function)
    }
    ...
    pub fn standard_deviation_unit_price(self) -> Self {
        self.standard_deviation_unit_price_as("stdDev_unit_price")
    }

    pub fn standard_deviation_unit_price_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_stddev("unit_price", alias)
    }

    pub fn square_root_of_population_standard_deviation_unit_price(self) -> Self {
        self.square_root_of_population_standard_deviation_unit_price_as("stdDevPop_unit_price")
    }

    pub fn square_root_of_population_standard_deviation_unit_price_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_stddev_pop("unit_price", alias)
    }

    pub fn sample_variance_unit_price(self) -> Self {
        self.sample_variance_unit_price_as("varSamp_unit_price")
    }

    pub fn sample_variance_unit_price_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_var_samp("unit_price", alias)
    }

    pub fn sample_population_variance_unit_price(self) -> Self {
        self.sample_population_variance_unit_price_as("varPop_unit_price")
    }

    pub fn sample_population_variance_unit_price_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_var_pop("unit_price", alias)
    }
...
impl<R> Default for OrderItemRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< OrderItemRequest<R> > for SelectQuery {
    fn from(request: OrderItemRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< OrderItemRequest<R> > for QuerySelection {
    fn from(request: OrderItemRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::OrderItem> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::OrderItemRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<OrderItemRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::OrderItem
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::OrderItem::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> OrderItemRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::OrderItemRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
