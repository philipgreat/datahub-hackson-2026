...
impl<R> UserAccountRequest<R> {
    ...
    pub fn user_name_is_string(self) -> Self {
        self.with_user_name_is("string()")
    }

    pub fn with_user_name_is_string(self) -> Self {
        self.with_user_name_is("string()")
    }



    pub fn with_user_name_is_not_string(self) -> Self {
        self.with_user_name_is_not("string()")
    }
