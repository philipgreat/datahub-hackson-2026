...
"Generate a complete TeaQL domain model for the enterprise payment subsystem. Query the DataHub MCP Server for the dataset URN: `urn:li:dataset:(urn:li:dataPlatform:snowflake,prod.finance.payment_transactions,PROD)`.
