...
impl<R> ExpenseRequest<R> {
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("date_incurred");
    ...
    pub fn select_date_incurred(mut self) -> Self {
        self.query = self.query.project("date_incurred");
        self
    }

    pub fn project_date_incurred(self) -> Self {
        self.select_date_incurred()
    }

    pub fn select_date_incurred_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_date_incurred_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_date_incurred_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("date_incurred", raw_sql_segment));
        self
    }

    pub fn group_by_date_incurred(self) -> Self {
        self.group_by("date_incurred")
    }

    pub fn group_by_date_incurred_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("date_incurred");
        request.query = request
            .query
            .project_expr(alias, Expr::column("date_incurred"));
        request
    }

    pub fn group_by_date_incurred_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("date_incurred")
            .aggregate_with_function("date_incurred", alias, function)
    }

    pub fn count_date_incurred(self) -> Self {
        self.count_date_incurred_as("date_incurred_count")
    }

    pub fn count_date_incurred_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("date_incurred", alias)
    }

    pub fn sum_date_incurred(self) -> Self {
        self.sum_date_incurred_as("sum_date_incurred")
    }

    pub fn sum_date_incurred_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("date_incurred", alias)
    }

    pub fn avg_date_incurred(self) -> Self {
        self.avg_date_incurred_as("avg_date_incurred")
    }

    pub fn avg_date_incurred_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("date_incurred", alias)
    }

    pub fn min_date_incurred(self) -> Self {
        self.min_date_incurred_as("min_date_incurred")
    }

    pub fn min_date_incurred_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("date_incurred", alias)
    }

    pub fn max_date_incurred(self) -> Self {
        self.max_date_incurred_as("max_date_incurred")
    }

    pub fn max_date_incurred_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("date_incurred", alias)
    }

    pub fn unselect_date_incurred(mut self) -> Self {
        self.query.projection.retain(|field| field != "date_incurred");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "date_incurred");
        self
    }


    pub fn with_date_incurred(
        mut self,
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
    ...
    pub fn create_date_incurred_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_date_incurred_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("date_incurred", value));
        self
    }



    pub fn with_date_incurred_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("date_incurred", value));
        self
    }

    pub fn with_date_incurred_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("date_incurred", value));
        self
    }

    pub fn with_date_incurred_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("date_incurred", value));
        self
    }

    pub fn with_date_incurred_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("date_incurred", value));
        self
    }

    pub fn with_date_incurred_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("date_incurred", value));
        self
    }

    pub fn with_date_incurred_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("date_incurred", lower, upper));
        self
    }

    pub fn with_date_incurred_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_date_incurred_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_date_incurred_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("date_incurred", value));
        self
    }

    pub fn with_date_incurred_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("date_incurred", value));
        self
    }

    pub fn with_date_incurred_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("date_incurred"));
        self
    }



    pub fn with_date_incurred_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("date_incurred"));
        self
    }


    pub fn order_by_date_incurred_asc(mut self) -> Self {
        self.query = self.query.order_asc("date_incurred");
        self
    }

    pub fn order_by_date_incurred_desc(mut self) -> Self {
        self.query = self.query.order_desc("date_incurred");
        self
    }

    pub fn order_by_date_incurred_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("date_incurred");
        self
    }

    pub fn order_by_date_incurred_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("date_incurred");
        self
    }
