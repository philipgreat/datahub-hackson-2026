...
#[teaql(entity = "Promotion", table = "promotion_data", data_service = "sqlite")]
pub struct Promotion {
#[teaql(id)]
    id: u64,

// @source massive_erp_model.xml:281
    name: String,
...
#[teaql(version)]
    version: i64,
#[teaql(relation(target = "Coupon", local_key = "id", foreign_key = "promotion_id", many))]
    coupon_list: SmartList<crate::Coupon>,
    #[teaql(dynamic)]
...
impl Promotion {
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("Promotion", self.id)
    }

    pub fn attach_root_recursive(&mut self, root: teaql_runtime::EntityRoot) {
        self.root = root.clone();
        for entity in &mut self.coupon_list {
    ...
    pub fn discount_percentage(&self) -> rust_decimal::Decimal {
        self.changed_discount_percentage().and_then(|value| value.try_decimal()).unwrap_or(self.discount_percentage)
    }

    pub fn update_discount_percentage(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.discount_percentage = value.try_decimal().unwrap_or(self.discount_percentage.clone());
        self.root.set(self.entity_key(), "discount_percentage", value);
        self
    }

    pub fn changed_discount_percentage(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "discount_percentage")
    }

    pub fn eval_discount_percentage(&self) -> teaql_core::eval::EvalResult<rust_decimal::Decimal> {
        if !self.is_loaded("discount_percentage") {
                    teaql_core::eval::EvalResult::NotLoaded { failed_node: "discount_percentage".to_string(), attempted_path: "discount_percentage".to_string() }
                } else {
                    teaql_core::eval::EvalResult::Value(self.discount_percentage())
                }}
    ...
    pub fn coupon_list(&self) -> &SmartList<crate::Coupon> {
        &self.coupon_list
    }

    pub fn coupon_list_mut(&mut self) -> &mut SmartList<crate::Coupon> {
        &mut self.coupon_list
    }

    pub fn eval_coupon_list(&self) -> teaql_core::eval::EvalResult<&SmartList<crate::Coupon>> {
        if !self.is_loaded("coupon_list") {
            teaql_core::eval::EvalResult::NotLoaded { failed_node: "coupon_list".to_string(), attempted_path: "coupon_list".to_string() }
        } else {
            teaql_core::eval::EvalResult::Value(&self.coupon_list)
        }
    }
