...
impl EntityReference for crate::ProductReview {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/product_review
#[derive(Debug)]
pub struct ProductReviewRequest<R = crate::ProductReview> {
    query: SelectQuery,
...
impl<R> Clone for ProductReviewRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> ProductReviewRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("ProductReview")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> ProductReviewRequest<T> {
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for ProductReview is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("review_text");
    ...
    pub fn select_review_text(mut self) -> Self {
        self.query = self.query.project("review_text");
        self
    }

    pub fn project_review_text(self) -> Self {
        self.select_review_text()
    }

    pub fn select_review_text_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_review_text_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_review_text_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("review_text", raw_sql_segment));
        self
    }

    pub fn group_by_review_text(self) -> Self {
        self.group_by("review_text")
    }

    pub fn group_by_review_text_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("review_text");
        request.query = request
            .query
            .project_expr(alias, Expr::column("review_text"));
        request
    }

    pub fn group_by_review_text_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("review_text")
            .aggregate_with_function("review_text", alias, function)
    }

    pub fn count_review_text(self) -> Self {
        self.count_review_text_as("review_text_count")
    }

    pub fn count_review_text_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("review_text", alias)
    }

    pub fn sum_review_text(self) -> Self {
        self.sum_review_text_as("sum_review_text")
    }

    pub fn sum_review_text_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("review_text", alias)
    }

    pub fn avg_review_text(self) -> Self {
        self.avg_review_text_as("avg_review_text")
    }

    pub fn avg_review_text_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("review_text", alias)
    }

    pub fn min_review_text(self) -> Self {
        self.min_review_text_as("min_review_text")
    }

    pub fn min_review_text_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("review_text", alias)
    }

    pub fn max_review_text(self) -> Self {
        self.max_review_text_as("max_review_text")
    }

    pub fn max_review_text_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("review_text", alias)
    }

    pub fn unselect_review_text(mut self) -> Self {
        self.query.projection.retain(|field| field != "review_text");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "review_text");
        self
    }


    pub fn with_review_text(
        mut self,
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
    ...
    pub fn create_review_text_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_review_text_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("review_text", value));
        self
    }



    pub fn with_review_text_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("review_text", value));
        self
    }

    pub fn with_review_text_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("review_text", value));
        self
    }

    pub fn with_review_text_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("review_text", value));
        self
    }

    pub fn with_review_text_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("review_text", value));
        self
    }

    pub fn with_review_text_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("review_text", value));
        self
    }

    pub fn with_review_text_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("review_text", lower, upper));
        self
    }

    pub fn with_review_text_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_review_text_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_review_text_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("review_text", value));
        self
    }

    pub fn with_review_text_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("review_text", value));
        self
    }

    pub fn with_review_text_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("review_text", value));
        self
    }

    pub fn with_review_text_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("review_text", value));
        self
    }

    pub fn with_review_text_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("review_text", value));
        self
    }

    pub fn with_review_text_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("review_text", value));
        self
    }

    pub fn with_review_text_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("review_text", value));
        self
    }
    pub fn with_review_text_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("review_text", value));
        self
    }

    pub fn with_review_text_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("review_text", value));
        self
    }

    pub fn with_review_text_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("review_text"));
        self
    }



    pub fn with_review_text_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("review_text"));
        self
    }


    pub fn order_by_review_text_asc(mut self) -> Self {
        self.query = self.query.order_asc("review_text");
        self
    }

    pub fn order_by_review_text_desc(mut self) -> Self {
        self.query = self.query.order_desc("review_text");
        self
    }

    pub fn order_by_review_text_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("review_text");
        self
    }

    pub fn order_by_review_text_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("review_text");
        self
    }
...
impl<R> Default for ProductReviewRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< ProductReviewRequest<R> > for SelectQuery {
    fn from(request: ProductReviewRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< ProductReviewRequest<R> > for QuerySelection {
    fn from(request: ProductReviewRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::ProductReview> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::ProductReviewRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<ProductReviewRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::ProductReview
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::ProductReview::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> ProductReviewRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::ProductReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
