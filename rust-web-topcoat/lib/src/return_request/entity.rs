...
#[teaql(entity = "ReturnRequest", table = "return_request_data", data_service = "sqlite")]
pub struct ReturnRequest {
#[teaql(id)]
    id: u64,

// @source massive_erp_model.xml:459
...
impl ReturnRequest {
    ...
    pub(crate) fn runtime_new(root: teaql_runtime::EntityRoot) -> Self {
        Self {
            id: 0_u64,
            refund_amount: rust_decimal::Decimal::ZERO,
            reason: String::new(),
            status: String::new(),
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("ReturnRequest", self.id)
    }
    ...
    pub fn refund_amount(&self) -> rust_decimal::Decimal {
        self.changed_refund_amount().and_then(|value| value.try_decimal()).unwrap_or(self.refund_amount)
    }

    pub fn update_refund_amount(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.refund_amount = value.try_decimal().unwrap_or(self.refund_amount.clone());
        self.root.set(self.entity_key(), "refund_amount", value);
        self
    }

    pub fn changed_refund_amount(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "refund_amount")
    }

    pub fn eval_refund_amount(&self) -> teaql_core::eval::EvalResult<rust_decimal::Decimal> {
        if !self.is_loaded("refund_amount") {
                    teaql_core::eval::EvalResult::NotLoaded { failed_node: "refund_amount".to_string(), attempted_path: "refund_amount".to_string() }
                } else {
                    teaql_core::eval::EvalResult::Value(self.refund_amount())
                }}
