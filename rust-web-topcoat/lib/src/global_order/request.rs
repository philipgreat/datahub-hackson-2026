...
impl EntityReference for crate::GlobalOrder {
...
#[derive(Debug)]
pub struct GlobalOrderRequest<R = crate::GlobalOrder> {
    query: SelectQuery,
...
impl<R> Clone for GlobalOrderRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> GlobalOrderRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("GlobalOrder")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> GlobalOrderRequest<T> {
        GlobalOrderRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
        let repository = ctx
            .global_order_repository()
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for GlobalOrder is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("shipping_address");
    ...
    pub fn select_shipping_address(mut self) -> Self {
        self.query = self.query.project("shipping_address");
        self
    }

    pub fn project_shipping_address(self) -> Self {
        self.select_shipping_address()
    }

    pub fn select_shipping_address_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_shipping_address_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_shipping_address_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("shipping_address", raw_sql_segment));
        self
    }

    pub fn group_by_shipping_address(self) -> Self {
        self.group_by("shipping_address")
    }

    pub fn group_by_shipping_address_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("shipping_address");
        request.query = request
            .query
            .project_expr(alias, Expr::column("shipping_address"));
        request
    }

    pub fn group_by_shipping_address_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("shipping_address")
            .aggregate_with_function("shipping_address", alias, function)
    }

    pub fn count_shipping_address(self) -> Self {
        self.count_shipping_address_as("shipping_address_count")
    }

    pub fn count_shipping_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("shipping_address", alias)
    }

    pub fn sum_shipping_address(self) -> Self {
        self.sum_shipping_address_as("sum_shipping_address")
    }

    pub fn sum_shipping_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("shipping_address", alias)
    }

    pub fn avg_shipping_address(self) -> Self {
        self.avg_shipping_address_as("avg_shipping_address")
    }

    pub fn avg_shipping_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("shipping_address", alias)
    }

    pub fn min_shipping_address(self) -> Self {
        self.min_shipping_address_as("min_shipping_address")
    }

    pub fn min_shipping_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("shipping_address", alias)
    }

    pub fn max_shipping_address(self) -> Self {
        self.max_shipping_address_as("max_shipping_address")
    }

    pub fn max_shipping_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("shipping_address", alias)
    }

    pub fn unselect_shipping_address(mut self) -> Self {
        self.query.projection.retain(|field| field != "shipping_address");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "shipping_address");
        self
    }


    pub fn with_shipping_address(
        mut self,
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
    ...
    pub fn create_shipping_address_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_shipping_address_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("shipping_address", value));
        self
    }



    pub fn with_shipping_address_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("shipping_address", value));
        self
    }

    pub fn with_shipping_address_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("shipping_address", value));
        self
    }

    pub fn with_shipping_address_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("shipping_address", value));
        self
    }

    pub fn with_shipping_address_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("shipping_address", value));
        self
    }

    pub fn with_shipping_address_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("shipping_address", value));
        self
    }

    pub fn with_shipping_address_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("shipping_address", lower, upper));
        self
    }

    pub fn with_shipping_address_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
    ...
    pub fn with_shipping_address_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::in_list(
    ...
    pub fn with_shipping_address_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_shipping_address_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("shipping_address", value));
        self
    }

    pub fn with_shipping_address_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("shipping_address", value));
        self
    }

    pub fn with_shipping_address_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("shipping_address", value));
        self
    }

    pub fn with_shipping_address_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("shipping_address", value));
        self
    }

    pub fn with_shipping_address_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("shipping_address", value));
        self
    }

    pub fn with_shipping_address_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("shipping_address", value));
        self
    }

    pub fn with_shipping_address_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("shipping_address", value));
        self
    }
    pub fn with_shipping_address_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("shipping_address", value));
        self
    }

    pub fn with_shipping_address_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("shipping_address", value));
        self
    }

    pub fn with_shipping_address_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("shipping_address"));
        self
    }



    pub fn with_shipping_address_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("shipping_address"));
        self
    }


    pub fn order_by_shipping_address_asc(mut self) -> Self {
        self.query = self.query.order_asc("shipping_address");
        self
    }

    pub fn order_by_shipping_address_desc(mut self) -> Self {
        self.query = self.query.order_desc("shipping_address");
        self
    }

    pub fn order_by_shipping_address_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("shipping_address");
        self
    }

    pub fn order_by_shipping_address_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("shipping_address");
        self
    }
...
impl<R> Default for GlobalOrderRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< GlobalOrderRequest<R> > for SelectQuery {
    fn from(request: GlobalOrderRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< GlobalOrderRequest<R> > for QuerySelection {
    fn from(request: GlobalOrderRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::GlobalOrder> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::GlobalOrderRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<GlobalOrderRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::GlobalOrder
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::GlobalOrder::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> GlobalOrderRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::GlobalOrderRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
