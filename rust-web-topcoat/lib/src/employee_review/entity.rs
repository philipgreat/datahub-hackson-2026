...
#[teaql(entity = "EmployeeReview", table = "employee_review_data", data_service = "sqlite")]
pub struct EmployeeReview {
#[teaql(id)]
    id: u64,

// @source massive_erp_model.xml:80
    comments: String,

// @source massive_erp_model.xml:80
    review_date: teaql_core::time::Timestamp,
...
impl EmployeeReview {
    ...
    pub(crate) fn runtime_new(root: teaql_runtime::EntityRoot) -> Self {
        Self {
            id: 0_u64,
            comments: String::new(),
            review_date: teaql_core::time::Timestamp::now(),
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("EmployeeReview", self.id)
    }
    ...
    pub fn review_date(&self) -> teaql_core::time::Timestamp {
        self.changed_review_date().and_then(|value| value.try_timestamp()).unwrap_or(self.review_date)
    }

    pub fn update_review_date(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.review_date = value.try_timestamp().unwrap_or(self.review_date.clone());
    ...
    pub fn eval_review_date(&self) -> teaql_core::eval::EvalResult<teaql_core::time::Timestamp> {
    ...
    pub fn reviewer_id(&self) -> String {
        self.changed_reviewer_id().and_then(|value| value.try_text().map(|value| value.to_owned())).unwrap_or_else(|| self.reviewer_id.clone())
    }

    pub fn update_reviewer_id(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.reviewer_id = value.try_text().map(|value| value.trim().to_owned()).unwrap_or_else(|| self.reviewer_id.clone());
    ...
    pub fn eval_reviewer_id(&self) -> teaql_core::eval::EvalResult<String> {
    ...
    pub fn score(&self) -> rust_decimal::Decimal {
        self.changed_score().and_then(|value| value.try_decimal()).unwrap_or(self.score)
    }

    pub fn update_score(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.score = value.try_decimal().unwrap_or(self.score.clone());
    ...
    pub fn eval_score(&self) -> teaql_core::eval::EvalResult<rust_decimal::Decimal> {
