...
#[teaql(entity = "Attendance", table = "attendance_data", data_service = "sqlite")]
pub struct Attendance {
#[teaql(id)]
    id: u64,

// @source massive_erp_model.xml:59
    check_in: teaql_core::time::Timestamp,

// @source massive_erp_model.xml:59
    check_out: teaql_core::time::Timestamp,
...
impl Attendance {
    ...
    pub(crate) fn runtime_new(root: teaql_runtime::EntityRoot) -> Self {
        Self {
            id: 0_u64,
            check_in: teaql_core::time::Timestamp::now(),
            check_out: teaql_core::time::Timestamp::now(),
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("Attendance", self.id)
    }
    ...
    pub fn check_in(&self) -> teaql_core::time::Timestamp {
        self.changed_check_in().and_then(|value| value.try_timestamp()).unwrap_or(self.check_in)
    }

    pub fn update_check_in(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.check_in = value.try_timestamp().unwrap_or(self.check_in.clone());
    ...
    pub fn eval_check_in(&self) -> teaql_core::eval::EvalResult<teaql_core::time::Timestamp> {
    ...
    pub fn check_out(&self) -> teaql_core::time::Timestamp {
        self.changed_check_out().and_then(|value| value.try_timestamp()).unwrap_or(self.check_out)
    }

    pub fn update_check_out(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.check_out = value.try_timestamp().unwrap_or(self.check_out.clone());
    ...
    pub fn eval_check_out(&self) -> teaql_core::eval::EvalResult<teaql_core::time::Timestamp> {
