...
#[teaql(entity = "ShoppingCart", table = "shopping_cart_data", data_service = "sqlite")]
pub struct ShoppingCart {
#[teaql(id)]
    id: u64,

// @source massive_erp_model.xml:232
...
#[teaql(relation(target = "CartItem", local_key = "id", foreign_key = "shopping_cart_id", many))]
...
impl ShoppingCart {
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("ShoppingCart", self.id)
    }
    ...
    pub fn is_abandoned(&self) -> bool {
        self.changed_is_abandoned().and_then(|value| value.try_bool()).unwrap_or(self.is_abandoned)
    }

    pub fn update_is_abandoned(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.is_abandoned = value.try_bool().unwrap_or(self.is_abandoned.clone());
        self.root.set(self.entity_key(), "is_abandoned", value);
        self
    }

    pub fn changed_is_abandoned(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "is_abandoned")
    }

    pub fn eval_is_abandoned(&self) -> teaql_core::eval::EvalResult<bool> {
        if !self.is_loaded("is_abandoned") {
                    teaql_core::eval::EvalResult::NotLoaded { failed_node: "is_abandoned".to_string(), attempted_path: "is_abandoned".to_string() }
                } else {
                    teaql_core::eval::EvalResult::Value(self.is_abandoned())
                }}

    pub fn session_id(&self) -> String {
        self.changed_session_id().and_then(|value| value.try_text().map(|value| value.to_owned())).unwrap_or_else(|| self.session_id.clone())
    }

    pub fn update_session_id(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.session_id = value.try_text().map(|value| value.trim().to_owned()).unwrap_or_else(|| self.session_id.clone());
        self.root.set(self.entity_key(), "session_id", value);
        self
    }

    pub fn changed_session_id(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "session_id")
    }

    pub fn eval_session_id(&self) -> teaql_core::eval::EvalResult<String> {
        if !self.is_loaded("session_id") {
                    teaql_core::eval::EvalResult::NotLoaded { failed_node: "session_id".to_string(), attempted_path: "session_id".to_string() }
                } else {
                    teaql_core::eval::EvalResult::Value(self.session_id())
                }}
