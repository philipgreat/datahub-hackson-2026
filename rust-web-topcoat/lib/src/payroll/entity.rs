...
// @source massive_erp_model.xml:92
...
// @source massive_erp_model.xml:92
    period_end: teaql_core::time::Timestamp,

// @source massive_erp_model.xml:92
    period_start: teaql_core::time::Timestamp,
...
impl Payroll {
    ...
    pub(crate) fn runtime_new(root: teaql_runtime::EntityRoot) -> Self {
        Self {
            ...
            period_end: teaql_core::time::Timestamp::now(),
            period_start: teaql_core::time::Timestamp::now(),
    ...
    pub fn tax(&self) -> rust_decimal::Decimal {
        self.changed_tax().and_then(|value| value.try_decimal()).unwrap_or(self.tax)
    }

    pub fn update_tax(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.tax = value.try_decimal().unwrap_or(self.tax.clone());
        self.root.set(self.entity_key(), "tax", value);
        self
    }

    pub fn changed_tax(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "tax")
    }

    pub fn eval_tax(&self) -> teaql_core::eval::EvalResult<rust_decimal::Decimal> {
        if !self.is_loaded("tax") {
                    teaql_core::eval::EvalResult::NotLoaded { failed_node: "tax".to_string(), attempted_path: "tax".to_string() }
                } else {
                    teaql_core::eval::EvalResult::Value(self.tax())
                }}
    ...
    pub fn period_end(&self) -> teaql_core::time::Timestamp {
        self.changed_period_end().and_then(|value| value.try_timestamp()).unwrap_or(self.period_end)
    }

    pub fn update_period_end(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.period_end = value.try_timestamp().unwrap_or(self.period_end.clone());
    ...
    pub fn eval_period_end(&self) -> teaql_core::eval::EvalResult<teaql_core::time::Timestamp> {
    ...
    pub fn period_start(&self) -> teaql_core::time::Timestamp {
        self.changed_period_start().and_then(|value| value.try_timestamp()).unwrap_or(self.period_start)
    }

    pub fn update_period_start(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.period_start = value.try_timestamp().unwrap_or(self.period_start.clone());
    ...
    pub fn eval_period_start(&self) -> teaql_core::eval::EvalResult<teaql_core::time::Timestamp> {
