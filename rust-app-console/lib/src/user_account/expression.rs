...
impl<'a> UserAccountExpression<'a> {
    ...
    pub fn get_user_id(self) -> crate::ValueExpression<'a, String> {
        let next = self.result.and_then("user_id", |entity| entity.eval_user_id());
        crate::ValueExpression::new(next, self.root_desc.clone())
    }

    pub fn get_user_name(self) -> crate::ValueExpression<'a, String> {
        let next = self.result.and_then("user_name", |entity| entity.eval_user_name());
        crate::ValueExpression::new(next, self.root_desc.clone())
    }
    ...
    pub fn get_payment_account_list(self) -> crate::PaymentAccountListExpression<'a> {
        let next = self.result.and_then("payment_account_list", |entity| entity.eval_payment_account_list());
        crate::PaymentAccountListExpression::new(next, self.root_desc.clone())
    }
}
