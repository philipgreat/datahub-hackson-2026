...
impl EntityReference for crate::Review {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/review
#[derive(Debug)]
pub struct ReviewRequest<R = crate::Review> {
    query: SelectQuery,
...
impl<R> Clone for ReviewRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> ReviewRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("Review")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> ReviewRequest<T> {
        ReviewRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for Review is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("comment");
    ...
    pub fn select_comment(mut self) -> Self {
        self.query = self.query.project("comment");
        self
    }

    pub fn project_comment(self) -> Self {
        self.select_comment()
    }

    pub fn select_comment_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_comment_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_comment_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("comment", raw_sql_segment));
        self
    }

    pub fn group_by_comment(self) -> Self {
        self.group_by("comment")
    }

    pub fn group_by_comment_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("comment");
        request.query = request
            .query
            .project_expr(alias, Expr::column("comment"));
        request
    }

    pub fn group_by_comment_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("comment")
            .aggregate_with_function("comment", alias, function)
    }

    pub fn count_comment(self) -> Self {
        self.count_comment_as("comment_count")
    }

    pub fn count_comment_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("comment", alias)
    }

    pub fn sum_comment(self) -> Self {
        self.sum_comment_as("sum_comment")
    }

    pub fn sum_comment_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("comment", alias)
    }

    pub fn avg_comment(self) -> Self {
        self.avg_comment_as("avg_comment")
    }

    pub fn avg_comment_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("comment", alias)
    }

    pub fn min_comment(self) -> Self {
        self.min_comment_as("min_comment")
    }

    pub fn min_comment_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("comment", alias)
    }

    pub fn max_comment(self) -> Self {
        self.max_comment_as("max_comment")
    }

    pub fn max_comment_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("comment", alias)
    }

    pub fn unselect_comment(mut self) -> Self {
        self.query.projection.retain(|field| field != "comment");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "comment");
        self
    }
    ...
    pub fn create_comment_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_comment_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("comment", value));
        self
    }



    pub fn with_comment_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("comment", value));
        self
    }

    pub fn with_comment_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("comment", value));
        self
    }

    pub fn with_comment_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("comment", value));
        self
    }

    pub fn with_comment_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("comment", value));
        self
    }

    pub fn with_comment_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("comment", value));
        self
    }

    pub fn with_comment_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("comment", lower, upper));
        self
    }

    pub fn with_comment_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_comment_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("comment", value));
        self
    }

    pub fn with_comment_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("comment", value));
        self
    }

    pub fn with_comment_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("comment", value));
        self
    }

    pub fn with_comment_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("comment", value));
        self
    }

    pub fn with_comment_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("comment", value));
        self
    }

    pub fn with_comment_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("comment", value));
        self
    }

    pub fn with_comment_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("comment", value));
        self
    }
    pub fn with_comment_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("comment", value));
        self
    }

    pub fn with_comment_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("comment", value));
        self
    }

    pub fn with_comment_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("comment"));
        self
    }



    pub fn with_comment_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("comment"));
        self
    }


    pub fn order_by_comment_asc(mut self) -> Self {
        self.query = self.query.order_asc("comment");
        self
    }

    pub fn order_by_comment_desc(mut self) -> Self {
        self.query = self.query.order_desc("comment");
        self
    }

    pub fn order_by_comment_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("comment");
        self
    }

    pub fn order_by_comment_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("comment");
        self
    }
...
impl<R> Default for ReviewRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< ReviewRequest<R> > for SelectQuery {
    fn from(request: ReviewRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< ReviewRequest<R> > for QuerySelection {
    fn from(request: ReviewRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::Review> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::ReviewRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<ReviewRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::Review
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::Review::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> ReviewRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::ReviewRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
