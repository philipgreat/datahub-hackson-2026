...
impl EntityReference for crate::MoveOrderStatus {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/move_order_status
#[derive(Debug)]
pub struct MoveOrderStatusRequest<R = crate::MoveOrderStatus> {
    query: SelectQuery,
...
impl<R> Clone for MoveOrderStatusRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> MoveOrderStatusRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("MoveOrderStatus")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> MoveOrderStatusRequest<T> {
        MoveOrderStatusRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
        let repository = ctx
            .move_order_status_repository()
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for MoveOrderStatus is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn name_is_confirmed(self) -> Self {
    ...
    pub fn name_is_assigned(self) -> Self {
        self.with_name_is("Assigned")
    }

    pub fn with_name_is_assigned(self) -> Self {
        self.with_name_is("Assigned")
    }



    pub fn with_name_is_not_assigned(self) -> Self {
        self.with_name_is_not("Assigned")
    }
    ...
    pub fn code_is_confirme_d(self) -> Self {
    ...
    pub fn code_is_assigne_d(self) -> Self {
        self.with_code_is("ASSIGNED")
    }

    pub fn with_code_is_assigne_d(self) -> Self {
        self.with_code_is("ASSIGNED")
    }



    pub fn with_code_is_not_assigne_d(self) -> Self {
        self.with_code_is_not("ASSIGNED")
    }
    ...
    pub fn color_is_value_7c3ae_d(self) -> Self {
        self.with_color_is("#7C3AED")
    }

    pub fn with_color_is_value_7c3ae_d(self) -> Self {
        self.with_color_is("#7C3AED")
    }



    pub fn with_color_is_not_value_7c3ae_d(self) -> Self {
        self.with_color_is_not("#7C3AED")
    }


    pub fn color_is_ea580_c(self) -> Self {
        self.with_color_is("#EA580C")
    }

    pub fn with_color_is_ea580_c(self) -> Self {
        self.with_color_is("#EA580C")
    }



    pub fn with_color_is_not_ea580_c(self) -> Self {
        self.with_color_is_not("#EA580C")
    }
    ...
    pub fn display_order_is_value_6(self) -> Self {
        self.with_display_order_is("6")
    }

    pub fn with_display_order_is_value_6(self) -> Self {
        self.with_display_order_is("6")
    }



    pub fn with_display_order_is_not_value_6(self) -> Self {
        self.with_display_order_is_not("6")
    }



    pub fn progress_is_value_5(self) -> Self {
        self.with_progress_is("5")
    }

    pub fn with_progress_is_value_5(self) -> Self {
        self.with_progress_is("5")
    }



    pub fn with_progress_is_not_value_5(self) -> Self {
        self.with_progress_is_not("5")
    }


    pub fn progress_is_value_20(self) -> Self {
        self.with_progress_is("20")
    }

    pub fn with_progress_is_value_20(self) -> Self {
        self.with_progress_is("20")
    }



    pub fn with_progress_is_not_value_20(self) -> Self {
        self.with_progress_is_not("20")
    }


    pub fn progress_is_value_40(self) -> Self {
        self.with_progress_is("40")
    }

    pub fn with_progress_is_value_40(self) -> Self {
        self.with_progress_is("40")
    }



    pub fn with_progress_is_not_value_40(self) -> Self {
        self.with_progress_is_not("40")
    }


    pub fn progress_is_value_70(self) -> Self {
        self.with_progress_is("70")
    }

    pub fn with_progress_is_value_70(self) -> Self {
        self.with_progress_is("70")
    }



    pub fn with_progress_is_not_value_70(self) -> Self {
        self.with_progress_is_not("70")
    }
...
impl<R> Default for MoveOrderStatusRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< MoveOrderStatusRequest<R> > for SelectQuery {
    fn from(request: MoveOrderStatusRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< MoveOrderStatusRequest<R> > for QuerySelection {
    fn from(request: MoveOrderStatusRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::MoveOrderStatus> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<MoveOrderStatusRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::MoveOrderStatus
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::MoveOrderStatus::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> MoveOrderStatusRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::MoveOrderStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
