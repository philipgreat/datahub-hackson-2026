...
impl<R> MoveOrderRequest<R> {
    ...
    fn dynamic_json_self_field(field: &str) -> Option<&'static str> {
        match field {
            "id" => Some("id"),
            "origin_address" => Some("origin_address"),
            ...
            "driver" | "driver_id" => Some("driver_id"),
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("origin_address");
        self.query = self.query.project("destination_address");
        self.query = self.query.project("scheduled_date");
        self.query = self.query.project("estimated_hours");
        self.query = self.query.project("special_instructions");
        self.query = self.query.project("create_time");
        self.query = self.query.project("update_time");
        self.query = self.query.project("version");
        self.query = self.query.project("company_id");
        self.query = self.query.project("customer_id");
        self.query = self.query.project("driver_id");
    ...
    pub fn project_origin_address(self) -> Self {
        self.select_origin_address()
    }

    pub fn select_origin_address_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_origin_address_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_origin_address_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("origin_address", raw_sql_segment));
        self
    }

    pub fn group_by_origin_address(self) -> Self {
        self.group_by("origin_address")
    }

    pub fn group_by_origin_address_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("origin_address");
        request.query = request
            .query
            .project_expr(alias, Expr::column("origin_address"));
        request
    }
    ...
    pub fn group_by_origin_address_with_function(
        ...
        self.group_by("origin_address")
            .aggregate_with_function("origin_address", alias, function)
    }
    ...
    pub fn count_origin_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("origin_address", alias)
    }

    pub fn sum_origin_address(self) -> Self {
        self.sum_origin_address_as("sum_origin_address")
    }

    pub fn sum_origin_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("origin_address", alias)
    }

    pub fn avg_origin_address(self) -> Self {
        self.avg_origin_address_as("avg_origin_address")
    }

    pub fn avg_origin_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("origin_address", alias)
    }

    pub fn min_origin_address(self) -> Self {
        self.min_origin_address_as("min_origin_address")
    }

    pub fn min_origin_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("origin_address", alias)
    }

    pub fn max_origin_address(self) -> Self {
        self.max_origin_address_as("max_origin_address")
    }

    pub fn max_origin_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("origin_address", alias)
    }

    pub fn unselect_origin_address(mut self) -> Self {
        self.query.projection.retain(|field| field != "origin_address");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "origin_address");
        self
    }


    pub fn with_origin_address(
        mut self,
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
    ...
    pub fn create_origin_address_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_origin_address_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("origin_address", value));
        self
    }



    pub fn with_origin_address_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("origin_address", value));
        self
    }

    pub fn with_origin_address_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("origin_address", value));
        self
    }

    pub fn with_origin_address_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("origin_address", value));
        self
    }

    pub fn with_origin_address_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("origin_address", value));
        self
    }

    pub fn with_origin_address_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("origin_address", value));
        self
    }

    pub fn with_origin_address_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("origin_address", lower, upper));
        self
    }

    pub fn with_origin_address_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
    ...
    pub fn with_origin_address_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_origin_address_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("origin_address", value));
        self
    }

    pub fn with_origin_address_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("origin_address", value));
        self
    }

    pub fn with_origin_address_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("origin_address", value));
        self
    }

    pub fn with_origin_address_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("origin_address", value));
        self
    }

    pub fn with_origin_address_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("origin_address", value));
        self
    }

    pub fn with_origin_address_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("origin_address", value));
        self
    }

    pub fn with_origin_address_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("origin_address", value));
        self
    }
    pub fn with_origin_address_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("origin_address", value));
        self
    }

    pub fn with_origin_address_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("origin_address", value));
        self
    }

    pub fn with_origin_address_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("origin_address"));
        self
    }



    pub fn with_origin_address_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("origin_address"));
        self
    }


    pub fn order_by_origin_address_asc(mut self) -> Self {
        self.query = self.query.order_asc("origin_address");
        self
    }

    pub fn order_by_origin_address_desc(mut self) -> Self {
        self.query = self.query.order_desc("origin_address");
        self
    }

    pub fn order_by_origin_address_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("origin_address");
        self
    }

    pub fn order_by_origin_address_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("origin_address");
        self
    }
    ...
    pub fn project_destination_address(self) -> Self {
        self.select_destination_address()
    }

    pub fn select_destination_address_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_destination_address_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_destination_address_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("destination_address", raw_sql_segment));
        self
    }

    pub fn group_by_destination_address(self) -> Self {
        self.group_by("destination_address")
    }

    pub fn group_by_destination_address_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("destination_address");
        request.query = request
            .query
            .project_expr(alias, Expr::column("destination_address"));
        request
    }
    ...
    pub fn group_by_destination_address_with_function(
        ...
        self.group_by("destination_address")
            .aggregate_with_function("destination_address", alias, function)
    }
    ...
    pub fn count_destination_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("destination_address", alias)
    }

    pub fn sum_destination_address(self) -> Self {
        self.sum_destination_address_as("sum_destination_address")
    }

    pub fn sum_destination_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("destination_address", alias)
    }

    pub fn avg_destination_address(self) -> Self {
        self.avg_destination_address_as("avg_destination_address")
    }

    pub fn avg_destination_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("destination_address", alias)
    }

    pub fn min_destination_address(self) -> Self {
        self.min_destination_address_as("min_destination_address")
    }

    pub fn min_destination_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("destination_address", alias)
    }

    pub fn max_destination_address(self) -> Self {
        self.max_destination_address_as("max_destination_address")
    }

    pub fn max_destination_address_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("destination_address", alias)
    }

    pub fn unselect_destination_address(mut self) -> Self {
        self.query.projection.retain(|field| field != "destination_address");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "destination_address");
        self
    }
    ...
    pub fn create_destination_address_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_destination_address_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("destination_address", value));
        self
    }



    pub fn with_destination_address_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("destination_address", value));
        self
    }

    pub fn with_destination_address_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("destination_address", value));
        self
    }

    pub fn with_destination_address_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("destination_address", value));
        self
    }

    pub fn with_destination_address_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("destination_address", value));
        self
    }

    pub fn with_destination_address_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("destination_address", value));
        self
    }

    pub fn with_destination_address_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("destination_address", lower, upper));
        self
    }

    pub fn with_destination_address_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_destination_address_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::in_list(
    ...
    pub fn with_destination_address_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_destination_address_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("destination_address", value));
        self
    }

    pub fn with_destination_address_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("destination_address", value));
        self
    }

    pub fn with_destination_address_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("destination_address", value));
        self
    }

    pub fn with_destination_address_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("destination_address", value));
        self
    }

    pub fn with_destination_address_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("destination_address", value));
        self
    }

    pub fn with_destination_address_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("destination_address", value));
        self
    }

    pub fn with_destination_address_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("destination_address", value));
        self
    }
    pub fn with_destination_address_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("destination_address", value));
        self
    }

    pub fn with_destination_address_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("destination_address", value));
        self
    }

    pub fn with_destination_address_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("destination_address"));
        self
    }



    pub fn with_destination_address_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("destination_address"));
        self
    }


    pub fn order_by_destination_address_asc(mut self) -> Self {
        self.query = self.query.order_asc("destination_address");
        self
    }

    pub fn order_by_destination_address_desc(mut self) -> Self {
        self.query = self.query.order_desc("destination_address");
        self
    }

    pub fn order_by_destination_address_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("destination_address");
        self
    }

    pub fn order_by_destination_address_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("destination_address");
        self
    }
    ...
    pub fn select_estimated_hours(mut self) -> Self {
        self.query = self.query.project("estimated_hours");
        self
    }

    pub fn project_estimated_hours(self) -> Self {
        self.select_estimated_hours()
    }

    pub fn select_estimated_hours_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_estimated_hours_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_estimated_hours_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("estimated_hours", raw_sql_segment));
        self
    }

    pub fn select_estimated_hours_with_function(self, function: AggregateFunction) -> Self {
        self.select_estimated_hours_as_with_function("estimated_hours", function)
    }

    pub fn select_estimated_hours_as_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.aggregate_with_function("estimated_hours", alias, function)
    }

    pub fn group_by_estimated_hours(self) -> Self {
        self.group_by("estimated_hours")
    }

    pub fn group_by_estimated_hours_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("estimated_hours");
        request.query = request
            .query
            .project_expr(alias, Expr::column("estimated_hours"));
        request
    }

    pub fn group_by_estimated_hours_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("estimated_hours")
            .aggregate_with_function("estimated_hours", alias, function)
    }

    pub fn count_estimated_hours(self) -> Self {
        self.count_estimated_hours_as("estimated_hours_count")
    }

    pub fn count_estimated_hours_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("estimated_hours", alias)
    }

    pub fn sum_estimated_hours(self) -> Self {
        self.sum_estimated_hours_as("sum_estimated_hours")
    }

    pub fn sum_estimated_hours_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("estimated_hours", alias)
    }

    pub fn avg_estimated_hours(self) -> Self {
        self.avg_estimated_hours_as("avg_estimated_hours")
    }

    pub fn avg_estimated_hours_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("estimated_hours", alias)
    }

    pub fn min_estimated_hours(self) -> Self {
        self.min_estimated_hours_as("min_estimated_hours")
    }

    pub fn min_estimated_hours_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("estimated_hours", alias)
    }

    pub fn max_estimated_hours(self) -> Self {
        self.max_estimated_hours_as("max_estimated_hours")
    }

    pub fn max_estimated_hours_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("estimated_hours", alias)
    }

    pub fn standard_deviation_estimated_hours(self) -> Self {
        self.standard_deviation_estimated_hours_as("stdDev_estimated_hours")
    }

    pub fn standard_deviation_estimated_hours_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_stddev("estimated_hours", alias)
    }

    pub fn square_root_of_population_standard_deviation_estimated_hours(self) -> Self {
        self.square_root_of_population_standard_deviation_estimated_hours_as("stdDevPop_estimated_hours")
    }

    pub fn square_root_of_population_standard_deviation_estimated_hours_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_stddev_pop("estimated_hours", alias)
    }

    pub fn sample_variance_estimated_hours(self) -> Self {
        self.sample_variance_estimated_hours_as("varSamp_estimated_hours")
    }

    pub fn sample_variance_estimated_hours_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_var_samp("estimated_hours", alias)
    }

    pub fn sample_population_variance_estimated_hours(self) -> Self {
        self.sample_population_variance_estimated_hours_as("varPop_estimated_hours")
    }

    pub fn sample_population_variance_estimated_hours_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_var_pop("estimated_hours", alias)
    }

    pub fn unselect_estimated_hours(mut self) -> Self {
        self.query.projection.retain(|field| field != "estimated_hours");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "estimated_hours");
        self
    }


    pub fn with_estimated_hours(
        mut self,
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
    ...
    pub fn create_estimated_hours_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_estimated_hours_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("estimated_hours", value));
        self
    }



    pub fn with_estimated_hours_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("estimated_hours", value));
        self
    }

    pub fn with_estimated_hours_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("estimated_hours", value));
        self
    }

    pub fn with_estimated_hours_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("estimated_hours", value));
        self
    }

    pub fn with_estimated_hours_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("estimated_hours", value));
        self
    }

    pub fn with_estimated_hours_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("estimated_hours", value));
        self
    }

    pub fn with_estimated_hours_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("estimated_hours", lower, upper));
        self
    }

    pub fn with_estimated_hours_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_estimated_hours_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::in_list(
    ...
    pub fn with_estimated_hours_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_estimated_hours_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("estimated_hours", value));
        self
    }

    pub fn with_estimated_hours_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("estimated_hours", value));
        self
    }

    pub fn with_estimated_hours_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("estimated_hours"));
        self
    }



    pub fn with_estimated_hours_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("estimated_hours"));
        self
    }


    pub fn order_by_estimated_hours_asc(mut self) -> Self {
        self.query = self.query.order_asc("estimated_hours");
        self
    }

    pub fn order_by_estimated_hours_desc(mut self) -> Self {
        self.query = self.query.order_desc("estimated_hours");
        self
    }

    pub fn order_by_estimated_hours_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("estimated_hours");
        self
    }

    pub fn order_by_estimated_hours_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("estimated_hours");
        self
    }


    pub fn select_special_instructions(mut self) -> Self {
        self.query = self.query.project("special_instructions");
        self
    }

    pub fn project_special_instructions(self) -> Self {
        self.select_special_instructions()
    }

    pub fn select_special_instructions_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_special_instructions_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_special_instructions_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("special_instructions", raw_sql_segment));
        self
    }

    pub fn group_by_special_instructions(self) -> Self {
        self.group_by("special_instructions")
    }

    pub fn group_by_special_instructions_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("special_instructions");
        request.query = request
            .query
            .project_expr(alias, Expr::column("special_instructions"));
        request
    }

    pub fn group_by_special_instructions_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("special_instructions")
            .aggregate_with_function("special_instructions", alias, function)
    }

    pub fn count_special_instructions(self) -> Self {
        self.count_special_instructions_as("special_instructions_count")
    }

    pub fn count_special_instructions_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("special_instructions", alias)
    }

    pub fn sum_special_instructions(self) -> Self {
        self.sum_special_instructions_as("sum_special_instructions")
    }

    pub fn sum_special_instructions_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("special_instructions", alias)
    }

    pub fn avg_special_instructions(self) -> Self {
        self.avg_special_instructions_as("avg_special_instructions")
    }

    pub fn avg_special_instructions_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("special_instructions", alias)
    }

    pub fn min_special_instructions(self) -> Self {
        self.min_special_instructions_as("min_special_instructions")
    }

    pub fn min_special_instructions_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("special_instructions", alias)
    }

    pub fn max_special_instructions(self) -> Self {
        self.max_special_instructions_as("max_special_instructions")
    }

    pub fn max_special_instructions_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("special_instructions", alias)
    }

    pub fn unselect_special_instructions(mut self) -> Self {
        self.query.projection.retain(|field| field != "special_instructions");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "special_instructions");
        self
    }


    pub fn with_special_instructions(
        mut self,
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
    ...
    pub fn create_special_instructions_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_special_instructions_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("special_instructions", value));
        self
    }



    pub fn with_special_instructions_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("special_instructions", value));
        self
    }

    pub fn with_special_instructions_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("special_instructions", value));
        self
    }

    pub fn with_special_instructions_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("special_instructions", value));
        self
    }

    pub fn with_special_instructions_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("special_instructions", value));
        self
    }

    pub fn with_special_instructions_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("special_instructions", value));
        self
    }

    pub fn with_special_instructions_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("special_instructions", lower, upper));
        self
    }

    pub fn with_special_instructions_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_special_instructions_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::in_list(
    ...
    pub fn with_special_instructions_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_special_instructions_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("special_instructions", value));
        self
    }

    pub fn with_special_instructions_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("special_instructions", value));
        self
    }

    pub fn with_special_instructions_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("special_instructions", value));
        self
    }

    pub fn with_special_instructions_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("special_instructions", value));
        self
    }

    pub fn with_special_instructions_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("special_instructions", value));
        self
    }

    pub fn with_special_instructions_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("special_instructions", value));
        self
    }

    pub fn with_special_instructions_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("special_instructions", value));
        self
    }
    pub fn with_special_instructions_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("special_instructions", value));
        self
    }

    pub fn with_special_instructions_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("special_instructions", value));
        self
    }

    pub fn with_special_instructions_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("special_instructions"));
        self
    }



    pub fn with_special_instructions_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("special_instructions"));
        self
    }


    pub fn order_by_special_instructions_asc(mut self) -> Self {
        self.query = self.query.order_asc("special_instructions");
        self
    }

    pub fn order_by_special_instructions_desc(mut self) -> Self {
        self.query = self.query.order_desc("special_instructions");
        self
    }

    pub fn order_by_special_instructions_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("special_instructions");
        self
    }

    pub fn order_by_special_instructions_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("special_instructions");
        self
    }
    ...
    pub fn filter_by_driver(mut self, value: impl EntityReference) -> Self {
        self.query = self.query.and_filter(Expr::eq("driver_id", value.entity_id_value()));
        self
    }

    pub fn with_driver_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.and_filter(Expr::in_subquery(
            "driver_id",
        ...
        self.relation_filters.push(RelationFilter::new("driver", selection));
        self
    }


    pub fn without_driver_matching(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.and_filter(Expr::not_in_subquery(
            "driver_id",
            <crate::Driver as teaql_core::TeaqlEntity>::entity_descriptor(),
    ...
    pub fn have_driver(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("driver_id"));
        self
    }

    pub fn have_no_driver(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("driver_id"));
        self
    }


    pub fn group_by_driver(self) -> Self {
        self.group_by("driver_id")
    }

    pub fn group_by_driver_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("driver_id");
        request.query = request
            .query
            .project_expr(alias, Expr::column("driver_id"));
        request
    }

    pub fn group_by_driver_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("driver_id")
            .aggregate_with_function("driver_id", alias, function)
    }

    pub fn group_by_driver_with(mut self, request: impl Into<QuerySelection>) -> Self {
        self.query = self.query.group_by("driver_id");
        self.query_options.object_group_bys.push(ObjectGroupBy::new(
            "driver",
            "driver_id",
            request,
    ...
    pub fn group_by_driver_with_details(self) -> Self {
        self.group_by_driver_with_details_from(crate::Q::drivers().unlimited())
    }

    pub fn group_by_driver_with_details_from(self, request: impl Into<QuerySelection>) -> Self {
        self.group_by_driver_with(request)
    }


    pub fn roll_up_to_driver(self) -> Self {
        self.roll_up_to_driver_with(crate::Q::drivers().unlimited())
    }

    pub fn roll_up_to_driver_with(self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.with_driver_matching(selection.clone())
            .group_by_driver_with(selection)
    }

    pub fn count_driver(self) -> Self {
        self.count_driver_as("driver_count")
    }

    pub fn count_driver_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("driver_id", alias)
    }

    pub fn unselect_driver(mut self) -> Self {
        self.query.projection.retain(|field| field != "driver_id");
        self.query.relations.retain(|relation| relation.name != "driver");
        self
    }
    ...
    /// let dynamic_query = crate::Q::move_order_statuses_minimal().filter(...);
    ...
    pub fn group_by_status_with_details(self) -> Self {
        self.group_by_status_with_details_from(crate::Q::move_order_statuses().unlimited())
    }
    ...
    pub fn roll_up_to_status(self) -> Self {
        self.roll_up_to_status_with(crate::Q::move_order_statuses().unlimited())
    }
    ...
    pub fn status_is_assigned(self) -> Self {
        self.filter_by_status(1003_u64)
    }

    pub fn with_status_is_assigned(self) -> Self {
        self.filter_by_status(1003_u64)
    }



    pub fn with_status_is_not_assigned(mut self) -> Self {
        self.query = self.query.and_filter(Expr::ne("status_id", 1003_u64));
        self
    }


    pub fn status_is_in_transit(self) -> Self {
        self.filter_by_status(1004_u64)
    }

    pub fn with_status_is_in_transit(self) -> Self {
        self.filter_by_status(1004_u64)
    }



    pub fn with_status_is_not_in_transit(mut self) -> Self {
        self.query = self.query.and_filter(Expr::ne("status_id", 1004_u64));
        self
    }


    pub fn status_is_delivered(self) -> Self {
        self.filter_by_status(1005_u64)
    }

    pub fn with_status_is_delivered(self) -> Self {
        self.filter_by_status(1005_u64)
    }



    pub fn with_status_is_not_delivered(mut self) -> Self {
    ...
    pub fn status_is_cancelled(self) -> Self {
        self.filter_by_status(1006_u64)
    }
    ...
    pub fn with_status_is_not_cancelled(mut self) -> Self {
        self.query = self.query.and_filter(Expr::ne("status_id", 1006_u64));
        self
    }
    ...
    pub fn select_driver(mut self) -> Self {
        self.query = self.query.relation("driver");
        self
    }

    pub fn select_driver_with(mut self, request: impl Into<QuerySelection>) -> Self {
        let selection = request.into();
        self.query = self.query.relation_query("driver", selection.clone().into_query());
        self.relation_selections.push(RelationSelection::new("driver", selection));
        self
}

    pub fn facet_by_driver_as(self, facet_name: impl Into<String>, request: impl Into<QuerySelection>) -> Self {
        self.facet_by_driver_as_with_options(facet_name, request, true)
    }

    pub fn facet_by_driver_as_with_options(
        mut self,
        facet_name: impl Into<String>,
        request: impl Into<QuerySelection>,
        include_all_facets: bool,
