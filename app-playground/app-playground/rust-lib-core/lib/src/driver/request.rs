...
impl EntityReference for crate::Driver {
...
// ⛔ AI agents: DO NOT read this file for API discovery. Instead run: cargo teaql --input modeling/MODEL.xml rust-assist-query/driver
#[derive(Debug)]
pub struct DriverRequest<R = crate::Driver> {
    query: SelectQuery,
...
impl<R> Clone for DriverRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> DriverRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("Driver")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> DriverRequest<T> {
        DriverRequest {
            query: self.query,
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for Driver is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("full_name");
        self.query = self.query.project("email");
        self.query = self.query.project("phone");
        self.query = self.query.project("license_number");
    ...
    pub fn select_full_name(mut self) -> Self {
        self.query = self.query.project("full_name");
        self
    }

    pub fn project_full_name(self) -> Self {
        self.select_full_name()
    }

    pub fn select_full_name_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_full_name_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_full_name_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("full_name", raw_sql_segment));
        self
    }

    pub fn group_by_full_name(self) -> Self {
        self.group_by("full_name")
    }

    pub fn group_by_full_name_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("full_name");
        request.query = request
            .query
            .project_expr(alias, Expr::column("full_name"));
        request
    }

    pub fn group_by_full_name_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("full_name")
            .aggregate_with_function("full_name", alias, function)
    }

    pub fn count_full_name(self) -> Self {
        self.count_full_name_as("full_name_count")
    }

    pub fn count_full_name_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("full_name", alias)
    }

    pub fn sum_full_name(self) -> Self {
        self.sum_full_name_as("sum_full_name")
    }

    pub fn sum_full_name_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("full_name", alias)
    }

    pub fn avg_full_name(self) -> Self {
        self.avg_full_name_as("avg_full_name")
    }

    pub fn avg_full_name_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("full_name", alias)
    }

    pub fn min_full_name(self) -> Self {
        self.min_full_name_as("min_full_name")
    }

    pub fn min_full_name_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("full_name", alias)
    }

    pub fn max_full_name(self) -> Self {
        self.max_full_name_as("max_full_name")
    }

    pub fn max_full_name_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("full_name", alias)
    }

    pub fn unselect_full_name(mut self) -> Self {
        self.query.projection.retain(|field| field != "full_name");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "full_name");
        self
    }
    ...
    pub fn create_full_name_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_full_name_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("full_name", value));
        self
    }



    pub fn with_full_name_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("full_name", value));
        self
    }

    pub fn with_full_name_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("full_name", value));
        self
    }

    pub fn with_full_name_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("full_name", value));
        self
    }

    pub fn with_full_name_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("full_name", value));
        self
    }

    pub fn with_full_name_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("full_name", value));
        self
    }

    pub fn with_full_name_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("full_name", lower, upper));
        self
    }

    pub fn with_full_name_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
    ...
    pub fn with_full_name_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("full_name", value));
        self
    }

    pub fn with_full_name_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("full_name", value));
        self
    }

    pub fn with_full_name_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("full_name", value));
        self
    }

    pub fn with_full_name_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("full_name", value));
        self
    }

    pub fn with_full_name_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("full_name", value));
        self
    }

    pub fn with_full_name_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("full_name", value));
        self
    }

    pub fn with_full_name_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("full_name", value));
        self
    }
    pub fn with_full_name_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("full_name", value));
        self
    }

    pub fn with_full_name_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("full_name", value));
        self
    }

    pub fn with_full_name_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("full_name"));
        self
    }



    pub fn with_full_name_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("full_name"));
        self
    }


    pub fn order_by_full_name_asc(mut self) -> Self {
        self.query = self.query.order_asc("full_name");
        self
    }

    pub fn order_by_full_name_desc(mut self) -> Self {
        self.query = self.query.order_desc("full_name");
        self
    }

    pub fn order_by_full_name_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("full_name");
        self
    }

    pub fn order_by_full_name_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("full_name");
        self
    }
    ...
    pub fn select_license_number(mut self) -> Self {
        self.query = self.query.project("license_number");
        self
    }

    pub fn project_license_number(self) -> Self {
        self.select_license_number()
    }

    pub fn select_license_number_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_license_number_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_license_number_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("license_number", raw_sql_segment));
        self
    }

    pub fn group_by_license_number(self) -> Self {
        self.group_by("license_number")
    }

    pub fn group_by_license_number_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("license_number");
        request.query = request
            .query
            .project_expr(alias, Expr::column("license_number"));
        request
    }

    pub fn group_by_license_number_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("license_number")
            .aggregate_with_function("license_number", alias, function)
    }

    pub fn count_license_number(self) -> Self {
        self.count_license_number_as("license_number_count")
    }

    pub fn count_license_number_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("license_number", alias)
    }

    pub fn sum_license_number(self) -> Self {
        self.sum_license_number_as("sum_license_number")
    }

    pub fn sum_license_number_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("license_number", alias)
    }

    pub fn avg_license_number(self) -> Self {
        self.avg_license_number_as("avg_license_number")
    }

    pub fn avg_license_number_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("license_number", alias)
    }

    pub fn min_license_number(self) -> Self {
        self.min_license_number_as("min_license_number")
    }

    pub fn min_license_number_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("license_number", alias)
    }

    pub fn max_license_number(self) -> Self {
        self.max_license_number_as("max_license_number")
    }

    pub fn max_license_number_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("license_number", alias)
    }

    pub fn unselect_license_number(mut self) -> Self {
        self.query.projection.retain(|field| field != "license_number");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "license_number");
        self
    }


    pub fn with_license_number(
        mut self,
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
    ...
    pub fn create_license_number_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_license_number_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("license_number", value));
        self
    }



    pub fn with_license_number_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("license_number", value));
        self
    }

    pub fn with_license_number_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("license_number", value));
        self
    }

    pub fn with_license_number_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("license_number", value));
        self
    }

    pub fn with_license_number_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("license_number", value));
        self
    }

    pub fn with_license_number_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("license_number", value));
        self
    }

    pub fn with_license_number_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("license_number", lower, upper));
        self
    }

    pub fn with_license_number_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_license_number_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_license_number_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("license_number", value));
        self
    }

    pub fn with_license_number_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("license_number", value));
        self
    }

    pub fn with_license_number_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("license_number", value));
        self
    }

    pub fn with_license_number_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("license_number", value));
        self
    }

    pub fn with_license_number_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("license_number", value));
        self
    }

    pub fn with_license_number_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("license_number", value));
        self
    }

    pub fn with_license_number_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("license_number", value));
        self
    }
    pub fn with_license_number_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("license_number", value));
        self
    }

    pub fn with_license_number_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("license_number", value));
        self
    }

    pub fn with_license_number_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("license_number"));
        self
    }



    pub fn with_license_number_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("license_number"));
        self
    }


    pub fn order_by_license_number_asc(mut self) -> Self {
        self.query = self.query.order_asc("license_number");
        self
    }

    pub fn order_by_license_number_desc(mut self) -> Self {
        self.query = self.query.order_desc("license_number");
        self
    }

    pub fn order_by_license_number_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("license_number");
        self
    }

    pub fn order_by_license_number_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("license_number");
        self
    }
...
impl<R> Default for DriverRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< DriverRequest<R> > for SelectQuery {
    fn from(request: DriverRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< DriverRequest<R> > for QuerySelection {
    fn from(request: DriverRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::Driver> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::DriverRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<DriverRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::Driver
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::Driver::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> DriverRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::DriverRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
