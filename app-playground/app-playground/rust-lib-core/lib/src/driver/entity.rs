...
#[teaql(entity = "Driver", table = "driver_data", data_service = "sqlite", audit_mask_fields = "password_hash,email,phone,full_name")]
pub struct Driver {
#[teaql(id)]
    id: u64,
...
#[teaql(relation(target = "MoveOrder", local_key = "id", foreign_key = "driver_id", many))]
...
impl Driver {
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("Driver", self.id)
    }
    ...
    pub fn full_name(&self) -> String {
        self.changed_full_name().and_then(|value| value.try_text().map(|value| value.to_owned())).unwrap_or_else(|| self.full_name.clone())
    }

    pub fn update_full_name(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.full_name = value.try_text().map(|value| value.trim().to_owned()).unwrap_or_else(|| self.full_name.clone());
        self.root.set(self.entity_key(), "full_name", value);
        self
    }

    pub fn changed_full_name(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "full_name")
    }

    pub fn eval_full_name(&self) -> teaql_core::eval::EvalResult<String> {
        if !self.is_loaded("full_name") {
                    teaql_core::eval::EvalResult::NotLoaded { failed_node: "full_name".to_string(), attempted_path: "full_name".to_string() }
                } else {
                    teaql_core::eval::EvalResult::Value(self.full_name())
                }}
    ...
    pub fn license_number(&self) -> String {
        self.changed_license_number().and_then(|value| value.try_text().map(|value| value.to_owned())).unwrap_or_else(|| self.license_number.clone())
    }

    pub fn update_license_number(&mut self, value: impl Into<teaql_core::Value>) -> &mut Self {
        let value = value.into();
        self.license_number = value.try_text().map(|value| value.trim().to_owned()).unwrap_or_else(|| self.license_number.clone());
        self.root.set(self.entity_key(), "license_number", value);
        self
    }

    pub fn changed_license_number(&self) -> Option<teaql_core::Value> {
        self.root.get(&self.entity_key(), "license_number")
    }

    pub fn eval_license_number(&self) -> teaql_core::eval::EvalResult<String> {
        if !self.is_loaded("license_number") {
                    teaql_core::eval::EvalResult::NotLoaded { failed_node: "license_number".to_string(), attempted_path: "license_number".to_string() }
                } else {
                    teaql_core::eval::EvalResult::Value(self.license_number())
                }}
