...
impl EntityReference for crate::PaymentStatus {
...
#[derive(Debug)]
pub struct PaymentStatusRequest<R = crate::PaymentStatus> {
    query: SelectQuery,
...
impl<R> Clone for PaymentStatusRequest<R> {
    fn clone(&self) -> Self {
        Self {
...
impl<R> PaymentStatusRequest<R> {
    pub(crate) fn new() -> Self {
        Self {
            query: SelectQuery::new("PaymentStatus")
                .project("id")
                .project("version"),
    ...
    pub fn return_type<T>(self) -> PaymentStatusRequest<T> {
    ...
    pub(crate) async fn _execute_for_list<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<R>, TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Vec<teaql_data_service::StreamChunk>, TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_first<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<R>, TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity,
    {
    ...
    pub(crate) async fn _execute_for_count<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<u64, TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
        ...
        rows.first()
            ...
            .ok_or_else(|| DataServiceError::Runtime(RuntimeError::Graph(format!("count result for PaymentStatus is missing or not numeric"))))
    }

    pub(crate) async fn _execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_records<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<SmartList<Record>, TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = ctx
    ...
    pub(crate) async fn _execute_for_record<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<Option<Record>, TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub fn name_is_success(self) -> Self {
        self.with_name_is("Success")
    }

    pub fn with_name_is_success(self) -> Self {
        self.with_name_is("Success")
    }



    pub fn with_name_is_not_success(self) -> Self {
        self.with_name_is_not("Success")
    }


    pub fn name_is_failed(self) -> Self {
        self.with_name_is("Failed")
    }

    pub fn with_name_is_failed(self) -> Self {
        self.with_name_is("Failed")
    }



    pub fn with_name_is_not_failed(self) -> Self {
        self.with_name_is_not("Failed")
    }
    ...
    pub fn code_is_succes_s(self) -> Self {
        self.with_code_is("SUCCESS")
    }

    pub fn with_code_is_succes_s(self) -> Self {
        self.with_code_is("SUCCESS")
    }



    pub fn with_code_is_not_succes_s(self) -> Self {
        self.with_code_is_not("SUCCESS")
    }


    pub fn code_is_faile_d(self) -> Self {
        self.with_code_is("FAILED")
    }

    pub fn with_code_is_faile_d(self) -> Self {
        self.with_code_is("FAILED")
    }



    pub fn with_code_is_not_faile_d(self) -> Self {
        self.with_code_is_not("FAILED")
    }
    ...
    pub fn color_is_dc2626(self) -> Self {
        self.with_color_is("#DC2626")
    }

    pub fn with_color_is_dc2626(self) -> Self {
        self.with_color_is("#DC2626")
    }



    pub fn with_color_is_not_dc2626(self) -> Self {
        self.with_color_is_not("#DC2626")
    }
...
impl<R> Default for PaymentStatusRequest<R> {
    fn default() -> Self {
        Self::new()
    }
}

impl<R> From< PaymentStatusRequest<R> > for SelectQuery {
    fn from(request: PaymentStatusRequest<R>) -> Self {
        QuerySelection::from(request).into_query()
    }
}

impl<R> From< PaymentStatusRequest<R> > for QuerySelection {
    fn from(request: PaymentStatusRequest<R>) -> Self {
        Self {
            query: request.query,
...
impl<'a, C> crate::request_support::AuditedSave<'a, C> for teaql_core::Audited<crate::PaymentStatus> 
where C: crate::request_support::TeaqlRepositoryProvider + ?Sized + 'a
{
    type Error = crate::TeaqlDataServiceError<C::PaymentStatusRepository<'a>>;
...
impl<R: teaql_core::Entity> crate::PurposedQuery<PaymentStatusRequest<R>> {
    pub fn new_entity<C>(&self, ctx: &C) -> crate::PaymentStatus
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        crate::PaymentStatus::runtime_new(ctx.user_context().entity_root())
    }

    fn into_inner_with_trace(mut self) -> PaymentStatusRequest<R> {
    ...
    pub async fn execute_for_page<'a, C>(
        ...
        offset: u64,
        limit: u64,
    ) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
    ...
    pub async fn execute_for_exists<'a, C>(
        self,
        ctx: &'a C,
    ) -> Result<bool, crate::request_support::TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_list<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, ctx: &'a C) -> Result<Vec<teaql_data_service::StreamChunk>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, ctx: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_records<'a, C>(self, ctx: &'a C) -> Result<teaql_core::SmartList<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_record<'a, C>(self, ctx: &'a C) -> Result<Option<teaql_core::Record>, crate::request_support::TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, ctx: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::PaymentStatusRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
