...
impl teaql_data_service::SchemaProvider for LocalSchemaProvider {
    fn get_entity(&self, name: &str) -> Option<std::sync::Arc<teaql_core::EntityDescriptor>> {
        match name {
            "PaymentAccount" => Some(std::sync::Arc::new(crate::PaymentAccount::entity_descriptor())),
            "PaymentMethod" => Some(std::sync::Arc::new(crate::PaymentMethod::entity_descriptor())),
            "PaymentStatus" => Some(std::sync::Arc::new(crate::PaymentStatus::entity_descriptor())),
...
pub async fn service_runtime_from_pool(pool: DataServicePool) -> Result<ServiceRuntime, ServiceRuntimeError> {
    ...
    let env_config = teaql_tool_core::audit_config_from_env(&[
        "payment_account_data", "payment_method_data", "payment_status_data", "payment_transaction_data"
    ]);
...
pub fn repository_registry() -> teaql_runtime::InMemoryEntityRegistry {
    teaql_runtime::InMemoryEntityRegistry::new()
        .with_entity("PaymentAccount")
        .with_entity("PaymentMethod")
        .with_entity("PaymentStatus")
...
pub fn behavior_registry() -> teaql_runtime::InMemoryEntityDataServiceBehaviorRegistry {
    teaql_runtime::InMemoryEntityDataServiceBehaviorRegistry::new()
        .with_behavior("PaymentAccount", PaymentAccountBehavior::default())
        .with_behavior("PaymentMethod", PaymentMethodBehavior::default())
        .with_behavior("PaymentStatus", PaymentStatusBehavior::default())
...
pub fn checker_registry() -> teaql_runtime::InMemoryCheckerRegistry {
    teaql_runtime::InMemoryCheckerRegistry::new()
        .with_checker(teaql_runtime::TypedEntityChecker::<PaymentAccount, _>::new(PaymentAccountChecker::default()))
        .with_checker(teaql_runtime::TypedEntityChecker::<PaymentMethod, _>::new(PaymentMethodChecker::default()))
        .with_checker(teaql_runtime::TypedEntityChecker::<PaymentStatus, _>::new(PaymentStatusChecker::default()))
...
pub fn module() -> teaql_runtime::RuntimeModule {
    teaql_runtime::RuntimeModule::new()
        ...
        .initial_graph(teaql_runtime::GraphNode::new("PaymentAccount")
            .value("id", 1_u64)
            .value("account_name", "Main Corporate Account")
            .value("account_number", 1234567890_i64)
            .value("currency_code", "USD")
            .value("create_time", teaql_core::time::Timestamp::now())
            .value("update_time", teaql_core::time::Timestamp::now())
            .value("version", 1_i64))
        .initial_graph(teaql_runtime::GraphNode::new("PaymentStatus")
            .value("id", 1001_u64)
            .value("name", "Pending")
            .value("code", "PENDING")
            .value("color", "#F59E0B")
            ...
            .value("progress", "0")
            .value("version", 1_i64)
            .value("payment_account_id", 1_u64))
        .initial_graph(teaql_runtime::GraphNode::new("PaymentStatus")
            .value("id", 1002_u64)
            .value("name", "Success")
            .value("code", "SUCCESS")
...
pub fn module_with_checkers() -> teaql_runtime::RuntimeModule {
    teaql_runtime::RuntimeModule::new()
        .entity::<PaymentAccount>()
        .checker(teaql_runtime::TypedEntityChecker::<PaymentAccount, _>::new(PaymentAccountChecker::default()))
        .entity::<PaymentMethod>()
        .checker(teaql_runtime::TypedEntityChecker::<PaymentMethod, _>::new(PaymentMethodChecker::default()))
        .entity::<PaymentStatus>()
        .checker(teaql_runtime::TypedEntityChecker::<PaymentStatus, _>::new(PaymentStatusChecker::default()))
        .entity::<PaymentTransaction>()
...
pub fn module_with_behaviors() -> teaql_runtime::RuntimeModule {
    teaql_runtime::RuntimeModule::new()
        .entity_with_behavior::<PaymentAccount, _>(PaymentAccountBehavior::default())
        .entity_with_behavior::<PaymentMethod, _>(PaymentMethodBehavior::default())
        .entity_with_behavior::<PaymentStatus, _>(PaymentStatusBehavior::default())
