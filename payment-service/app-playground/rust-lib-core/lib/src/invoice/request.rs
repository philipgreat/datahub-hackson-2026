...
impl<R> InvoiceRequest<R> {
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("paid_amount");
        self.query = self.query.project("is_paid");
    ...
    pub fn select_paid_amount(mut self) -> Self {
        self.query = self.query.project("paid_amount");
        self
    }

    pub fn project_paid_amount(self) -> Self {
        self.select_paid_amount()
    }

    pub fn select_paid_amount_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_paid_amount_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_paid_amount_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("paid_amount", raw_sql_segment));
        self
    }

    pub fn select_paid_amount_with_function(self, function: AggregateFunction) -> Self {
        self.select_paid_amount_as_with_function("paid_amount", function)
    }

    pub fn select_paid_amount_as_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.aggregate_with_function("paid_amount", alias, function)
    }

    pub fn group_by_paid_amount(self) -> Self {
        self.group_by("paid_amount")
    }

    pub fn group_by_paid_amount_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("paid_amount");
        request.query = request
            .query
            .project_expr(alias, Expr::column("paid_amount"));
        request
    }

    pub fn group_by_paid_amount_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("paid_amount")
            .aggregate_with_function("paid_amount", alias, function)
    }

    pub fn count_paid_amount(self) -> Self {
        self.count_paid_amount_as("paid_amount_count")
    }

    pub fn count_paid_amount_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("paid_amount", alias)
    }

    pub fn sum_paid_amount(self) -> Self {
        self.sum_paid_amount_as("sum_paid_amount")
    }

    pub fn sum_paid_amount_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("paid_amount", alias)
    }

    pub fn avg_paid_amount(self) -> Self {
        self.avg_paid_amount_as("avg_paid_amount")
    }

    pub fn avg_paid_amount_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("paid_amount", alias)
    }

    pub fn min_paid_amount(self) -> Self {
        self.min_paid_amount_as("min_paid_amount")
    }

    pub fn min_paid_amount_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("paid_amount", alias)
    }

    pub fn max_paid_amount(self) -> Self {
        self.max_paid_amount_as("max_paid_amount")
    }

    pub fn max_paid_amount_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("paid_amount", alias)
    }

    pub fn standard_deviation_paid_amount(self) -> Self {
        self.standard_deviation_paid_amount_as("stdDev_paid_amount")
    }

    pub fn standard_deviation_paid_amount_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_stddev("paid_amount", alias)
    }

    pub fn square_root_of_population_standard_deviation_paid_amount(self) -> Self {
        self.square_root_of_population_standard_deviation_paid_amount_as("stdDevPop_paid_amount")
    }

    pub fn square_root_of_population_standard_deviation_paid_amount_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_stddev_pop("paid_amount", alias)
    }

    pub fn sample_variance_paid_amount(self) -> Self {
        self.sample_variance_paid_amount_as("varSamp_paid_amount")
    }

    pub fn sample_variance_paid_amount_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_var_samp("paid_amount", alias)
    }

    pub fn sample_population_variance_paid_amount(self) -> Self {
        self.sample_population_variance_paid_amount_as("varPop_paid_amount")
    }

    pub fn sample_population_variance_paid_amount_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_var_pop("paid_amount", alias)
    }

    pub fn unselect_paid_amount(mut self) -> Self {
        self.query.projection.retain(|field| field != "paid_amount");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "paid_amount");
        self
    }


    pub fn with_paid_amount(
        mut self,
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
    ...
    pub fn create_paid_amount_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_paid_amount_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("paid_amount", value));
        self
    }



    pub fn with_paid_amount_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("paid_amount", value));
        self
    }

    pub fn with_paid_amount_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("paid_amount", value));
        self
    }

    pub fn with_paid_amount_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("paid_amount", value));
        self
    }

    pub fn with_paid_amount_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("paid_amount", value));
        self
    }

    pub fn with_paid_amount_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("paid_amount", value));
        self
    }

    pub fn with_paid_amount_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("paid_amount", lower, upper));
        self
    }

    pub fn with_paid_amount_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_paid_amount_not_in(
        mut self,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::not_in_list(
    ...
    pub fn with_paid_amount_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("paid_amount", value));
        self
    }

    pub fn with_paid_amount_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("paid_amount", value));
        self
    }

    pub fn with_paid_amount_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("paid_amount"));
        self
    }



    pub fn with_paid_amount_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("paid_amount"));
        self
    }


    pub fn order_by_paid_amount_asc(mut self) -> Self {
        self.query = self.query.order_asc("paid_amount");
        self
    }

    pub fn order_by_paid_amount_desc(mut self) -> Self {
        self.query = self.query.order_desc("paid_amount");
        self
    }

    pub fn order_by_paid_amount_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("paid_amount");
        self
    }

    pub fn order_by_paid_amount_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("paid_amount");
        self
    }


    pub fn select_is_paid(mut self) -> Self {
        self.query = self.query.project("is_paid");
        self
    }

    pub fn project_is_paid(self) -> Self {
        self.select_is_paid()
    }

    pub fn select_is_paid_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_is_paid_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_is_paid_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("is_paid", raw_sql_segment));
        self
    }

    pub fn group_by_is_paid(self) -> Self {
        self.group_by("is_paid")
    }

    pub fn group_by_is_paid_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("is_paid");
        request.query = request
            .query
            .project_expr(alias, Expr::column("is_paid"));
        request
    }

    pub fn group_by_is_paid_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("is_paid")
            .aggregate_with_function("is_paid", alias, function)
    }

    pub fn count_is_paid(self) -> Self {
        self.count_is_paid_as("is_paid_count")
    }

    pub fn count_is_paid_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("is_paid", alias)
    }

    pub fn sum_is_paid(self) -> Self {
        self.sum_is_paid_as("sum_is_paid")
    }

    pub fn sum_is_paid_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("is_paid", alias)
    }

    pub fn avg_is_paid(self) -> Self {
        self.avg_is_paid_as("avg_is_paid")
    }

    pub fn avg_is_paid_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("is_paid", alias)
    }

    pub fn min_is_paid(self) -> Self {
        self.min_is_paid_as("min_is_paid")
    }

    pub fn min_is_paid_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("is_paid", alias)
    }

    pub fn max_is_paid(self) -> Self {
        self.max_is_paid_as("max_is_paid")
    }

    pub fn max_is_paid_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("is_paid", alias)
    }

    pub fn unselect_is_paid(mut self) -> Self {
        self.query.projection.retain(|field| field != "is_paid");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "is_paid");
        self
    }
    ...
    pub fn create_is_paid_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_is_paid_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("is_paid", value));
        self
    }



    pub fn with_is_paid_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("is_paid", value));
        self
    }

    pub fn with_is_paid_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("is_paid", value));
        self
    }

    pub fn with_is_paid_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("is_paid", value));
        self
    }

    pub fn with_is_paid_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("is_paid", value));
        self
    }

    pub fn with_is_paid_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("is_paid", value));
        self
    }

    pub fn with_is_paid_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("is_paid", lower, upper));
        self
    }

    pub fn with_is_paid_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_is_paid_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("is_paid", value));
        self
    }

    pub fn with_is_paid_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("is_paid", value));
        self
    }

    pub fn with_is_paid_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("is_paid"));
        self
    }



    pub fn with_is_paid_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("is_paid"));
        self
    }


    pub fn order_by_is_paid_asc(mut self) -> Self {
        self.query = self.query.order_asc("is_paid");
        self
    }

    pub fn order_by_is_paid_desc(mut self) -> Self {
        self.query = self.query.order_desc("is_paid");
        self
    }

    pub fn order_by_is_paid_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("is_paid");
        self
    }

    pub fn order_by_is_paid_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("is_paid");
        self
    }
