...
pub trait TeaqlRepositoryProvider: TeaqlRuntime {
    ...
    type MoveOrderStatusRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;

    fn move_order_status_repository(&self) -> Result<Self::MoveOrderStatusRepository<'_>, ContextError>;
    ...
    type ReviewRepository<'a>: TeaqlEntityRepository + 'a
    where
        Self: 'a;

    fn review_repository(&self) -> Result<Self::ReviewRepository<'_>, ContextError>;
}
...
impl TeaqlRepositoryProvider for teaql_runtime::UserContext {
    ...
    type MoveOrderStatusRepository<'a> = teaql_runtime::EntityDataService<'a, crate::runtime::DataServiceExecutor>
    where
        Self: 'a;

    fn move_order_status_repository(&self) -> Result<Self::MoveOrderStatusRepository<'_>, ContextError> {
        self.entity_data_service::<crate::runtime::DataServiceExecutor>("MoveOrderStatus")
    }
    ...
    type ReviewRepository<'a> = teaql_runtime::EntityDataService<'a, crate::runtime::DataServiceExecutor>
    where
        Self: 'a;

    fn review_repository(&self) -> Result<Self::ReviewRepository<'_>, ContextError> {
        self.entity_data_service::<crate::runtime::DataServiceExecutor>("Review")
    }
}
