...
#[teaql(entity = "MoveOrderStatus", table = "move_order_status_data", data_service = "sqlite")]
pub struct MoveOrderStatus {
// @source moving-company.xml:66
#[teaql(id)]
    id: u64,
...
#[teaql(relation(target = "MoveOrder", local_key = "id", foreign_key = "status_id", many))]
...
impl MoveOrderStatus {
    ...
    pub fn entity_key(&self) -> teaql_runtime::EntityKey {
        teaql_runtime::EntityKey::new("MoveOrderStatus", self.id)
    }
