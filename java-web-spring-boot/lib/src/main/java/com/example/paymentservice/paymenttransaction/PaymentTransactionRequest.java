...
public class PaymentTransactionRequest<T extends PaymentTransaction> extends BaseRequest<T> {
    ...
    public PaymentTransactionRequest<T> selectSelf(){
        super.selectSelf();
        return selectId().selectPaymentAccountIdOnly().selectCurrencyCode().selectPaymentMethodIdOnly().selectTransactionAmount().selectCreateTime().selectUpdateTime().selectVersion();
    }
    ...
    public PaymentTransactionRequest<T> selectPaymentAccountWith(PaymentAccountRequest paymentAccount){
       selectProperty(PaymentTransaction.PAYMENT_ACCOUNT_PROPERTY);
    ...
    public PaymentTransactionRequest<T> selectPaymentMethodIdOnly(){
    ...
    public PaymentTransactionRequest<T> selectPaymentMethodWith(PaymentMethodRequest paymentMethod){
       selectProperty(PaymentTransaction.PAYMENT_METHOD_PROPERTY);
       enhanceRelation(PaymentTransaction.PAYMENT_METHOD_PROPERTY, paymentMethod);
       return this;
    }
    ...
    public PaymentTransactionRequest<T> filterByPaymentAccount(PaymentAccount... paymentAccount){
    ...
    public PaymentTransactionRequest<T> withPaymentAccountMatching(PaymentAccountRequest paymentAccount){
       return appendSearchCriteria(new SubQuerySearchCriteria(PaymentTransaction.PAYMENT_ACCOUNT_PROPERTY, paymentAccount, PaymentAccount.ID_PROPERTY));
    }
    ...
    public PaymentTransactionRequest<T> filterByPaymentMethod(PaymentMethod... paymentMethod){
    ...
    public PaymentTransactionRequest<T> filterByPaymentMethod(Long paymentMethod){
      if(paymentMethod == null){
         return this;
      }
      return withPaymentMethod(Operator.EQUAL, paymentMethod);
    }
    public PaymentTransactionRequest<T> withPaymentMethodMatching(PaymentMethodRequest paymentMethod){
       return appendSearchCriteria(new SubQuerySearchCriteria(PaymentTransaction.PAYMENT_METHOD_PROPERTY, paymentMethod, PaymentMethod.ID_PROPERTY));
    }
    ...
    public PaymentTransactionRequest<T> groupByPaymentAccountWithDetails(PaymentAccountRequest subRequest){
       aggregate(PaymentTransaction.PAYMENT_ACCOUNT_PROPERTY, subRequest);
       return this;
    }


    public PaymentTransactionRequest<T> groupByPaymentMethodWithDetails(){
       return groupByPaymentMethodWithDetails(Q.paymentMethods().unlimited());
    }

    public PaymentTransactionRequest<T> groupByPaymentMethodWithDetails(PaymentMethodRequest subRequest){
       aggregate(PaymentTransaction.PAYMENT_METHOD_PROPERTY, subRequest);
       return this;
    }
    ...
    public PaymentTransactionRequest<T> groupByPaymentAccountWith(PaymentAccountRequest subRequest){
    ...
    public PaymentTransactionRequest<T> groupByPaymentMethodWith(PaymentMethodRequest subRequest){
       groupBy(PaymentTransaction.PAYMENT_METHOD_PROPERTY, subRequest);
       return this;
    }
   ...
   public PaymentTransactionRequest<T> facetByPaymentAccountAs(String facetName, PaymentAccountRequest paymentAccount){
       return facetByPaymentAccountAs(facetName, paymentAccount, true);
   }

   public PaymentTransactionRequest<T> facetByPaymentAccountAs(String facetName, PaymentAccountRequest paymentAccount, boolean includeAllFacets){
       addFacet(facetName, PaymentTransaction.PAYMENT_ACCOUNT_PROPERTY, paymentAccount, includeAllFacets);
       return this;
   }
   public PaymentTransactionRequest<T> facetByPaymentMethodAs(String facetName, PaymentMethodRequest paymentMethod){
       return facetByPaymentMethodAs(facetName, paymentMethod, true);
   }

   public PaymentTransactionRequest<T> facetByPaymentMethodAs(String facetName, PaymentMethodRequest paymentMethod, boolean includeAllFacets){
       addFacet(facetName, PaymentTransaction.PAYMENT_METHOD_PROPERTY, paymentMethod, includeAllFacets);
       return this;
   }
